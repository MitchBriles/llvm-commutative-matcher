; ModuleID = '/home/mitch/Documents/PROJ/src/projections/eck5.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/eck5.cpp"
...
define hidden noundef ptr @pj_eck5(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL14eck5_s_inverse5PJ_XYP8PJconsts, ptr %5, align 8, !tbaa !37
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14eck5_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL8des_eck5, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z33pj_projection_specific_setup_eck5P8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL14eck5_s_inverse5PJ_XYP8PJconsts, ptr %3, align 8, !tbaa !37
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14eck5_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
...
define internal { double, double } @_ZL14eck5_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  ...
  %6 = tail call double @cos(double noundef %4) #5, !tbaa !44
  %7 = fadd double %6, 1.000000e+00
  %8 = fdiv double %5, %7
  %9 = insertvalue { double, double } poison, double %8, 0
  %10 = insertvalue { double, double } %9, double %4, 1
...
define internal { double, double } @_ZL14eck5_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  ...
  %9 = insertvalue { double, double } poison, double %7, 0
