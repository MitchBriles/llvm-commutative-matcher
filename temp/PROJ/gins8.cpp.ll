; ModuleID = '/home/mitch/Documents/PROJ/src/projections/gins8.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/gins8.cpp"
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL15gins8_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL9des_gins8, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z34pj_projection_specific_setup_gins8P8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  ...
  store ptr @_ZL15gins8_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
