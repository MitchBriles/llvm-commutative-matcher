; ModuleID = '/home/mitch/Documents/PROJ/src/projections/tmerc.cpp'
...
16:                                               ; preds = %10
  %17 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(15) @.str.12) #11
  %18 = icmp eq i32 %17, 0
...
20:                                               ; preds = %16
  %21 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(15) @.str.13) #11
  %22 = icmp eq i32 %21, 0
...
24:                                               ; preds = %20
  %25 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(5) @.str.14) #11
  %26 = icmp eq i32 %25, 0
...
22:                                               ; preds = %16
  ...
  %25 = tail call double @sin(double noundef %24) #10, !tbaa !77
  %26 = tail call double @cos(double noundef %24) #10, !tbaa !77
...
80:                                               ; preds = %74
  ...
  %83 = tail call double @sin(double noundef %82) #10, !tbaa !77
  %84 = tail call double @cos(double noundef %82) #10, !tbaa !77
...
121:                                              ; preds = %49, %98, %7, %48, %47, %95, %37, %5
...
40:                                               ; preds = %15
  ...
  %47 = tail call i64 @lround(double noundef %46) #10, !tbaa !77
...
define internal { double, double } @_ZL19tmerc_spherical_inv5PJ_XYP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  ...
  %8 = fdiv double %0, %7
  %9 = tail call double @exp(double noundef %8) #10, !tbaa !77
...
16:                                               ; preds = %3
  ...
  %24 = tail call double @cos(double noundef %23) #10, !tbaa !77
  %25 = fneg double %24
  ...
  %29 = tail call double @sqrt(double noundef %28) #10, !tbaa !77
  %30 = tail call double @asin(double noundef %29) #10, !tbaa !77
...
35:                                               ; preds = %16
  %36 = tail call double @atan2(double noundef %19, double noundef %24) #10, !tbaa !77
  br label %37
...
define internal { double, double } @_ZL19tmerc_spherical_fwd5PJ_LPP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  ...
  %6 = tail call double @cos(double noundef %1) #10, !tbaa !77
  %7 = tail call double @sin(double noundef %0) #10, !tbaa !77
  %8 = fmul double %6, %7
...
15:                                               ; preds = %3
  ...
  %21 = tail call double @log(double noundef %20) #10, !tbaa !77
  %22 = fmul double %17, %21
  %23 = tail call double @cos(double noundef %0) #10, !tbaa !77
  %24 = fmul double %6, %23
  %25 = fneg double %8
  %26 = tail call double @llvm.fmuladd.f64(double %25, double %8, double 1.000000e+00)
  %27 = tail call double @sqrt(double noundef %26) #10, !tbaa !77
  %28 = fdiv double %24, %27
  %29 = tail call double @llvm.fabs.f64(double %28)
  %30 = fcmp oeq double %6, 1.000000e+00
  %31 = tail call double @llvm.fabs.f64(double %0)
  %32 = fcmp ogt double %31, 0x3FF921FB54442D18
  %33 = and i1 %32, %30
  br i1 %33, label %43, label %34

34:                                               ; preds = %15
  %35 = fcmp ult double %29, 1.000000e+00
...
41:                                               ; preds = %34
  %42 = tail call double @acos(double noundef %28) #10, !tbaa !77
  br label %43

43:                                               ; preds = %36, %15, %41
  %44 = phi double [ %42, %41 ], [ 0x400921FB54442D18, %15 ], [ 0.000000e+00, %36 ]
  %45 = fcmp olt double %1, 0.000000e+00
  %46 = fneg double %44
  %47 = select i1 %45, double %46, double %44
  %48 = load double, ptr %5, align 8, !tbaa !79
  %49 = getelementptr inbounds nuw i8, ptr %2, i64 448
  %50 = load double, ptr %49, align 8, !tbaa !69
  %51 = fsub double %47, %50
  %52 = fmul double %48, %51
  br label %53

53:                                               ; preds = %43, %39, %13
  %54 = phi double [ 0.000000e+00, %13 ], [ %52, %43 ], [ %28, %39 ]
  %55 = phi double [ 0.000000e+00, %13 ], [ %22, %43 ], [ %22, %39 ]
  %56 = insertvalue { double, double } poison, double %55, 0
  %57 = insertvalue { double, double } %56, double %54, 1
...
20:                                               ; preds = %3
  %21 = tail call double @sin(double noundef %14) #10, !tbaa !77
  %22 = tail call double @cos(double noundef %14) #10, !tbaa !77
  ...
  %35 = tail call double @sqrt(double noundef %34) #10, !tbaa !77
  %36 = fmul double %0, %35
...
8:                                                ; preds = %3
  ...
  %11 = tail call double @sin(double noundef %1) #10, !tbaa !77
  %12 = tail call double @cos(double noundef %1) #10, !tbaa !77
  ...
  %25 = tail call double @sqrt(double noundef %24) #10, !tbaa !77
...
11:                                               ; preds = %3
  ...
  %17 = tail call double @sin(double noundef %16) #10, !tbaa !77
  %18 = tail call double @cos(double noundef %16) #10, !tbaa !77
  %19 = fmul double %8, 2.000000e+00
  %20 = tail call double @exp(double noundef %19) #10, !tbaa !77
  ...
  %82 = fadd double %8, %80
  %83 = tail call double @sin(double noundef %81) #10, !tbaa !77
  %84 = tail call double @cos(double noundef %81) #10, !tbaa !77
  %85 = tail call double @sinh(double noundef %82) #10, !tbaa !77
  %86 = tail call double @atan2(double noundef %85, double noundef %84) #10, !tbaa !77
  %87 = tail call double @hypot(double noundef %85, double noundef %84) #10, !tbaa !77
  %88 = tail call double @hypot(double noundef %83, double noundef %87) #10, !tbaa !77
  %89 = tail call double @atan2(double noundef %83, double noundef %87) #10, !tbaa !77
...
define internal { double, double } @_ZL11exact_e_fwd5PJ_LPP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  ...
  %8 = tail call double @sin(double noundef %7) #10, !tbaa !77
  %9 = tail call double @cos(double noundef %7) #10, !tbaa !77
  %10 = tail call double @sin(double noundef %0) #10, !tbaa !77
  %11 = tail call double @cos(double noundef %0) #10, !tbaa !77
  %12 = fmul double %9, %11
  %13 = tail call double @atan2(double noundef %8, double noundef %12) #10, !tbaa !77
  %14 = tail call double @hypot(double noundef %8, double noundef %12) #10, !tbaa !77
  %15 = fdiv double 1.000000e+00, %14
  %16 = fmul double %9, %10
  %17 = fmul double %16, %15
  %18 = tail call double @asinh(double noundef %17) #10, !tbaa !77
