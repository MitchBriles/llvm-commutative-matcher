; ModuleID = '/home/mitch/Documents/PROJ/src/iso19111/operation/projbasedoperation.cpp'
...
41:                                               ; preds = %36, %30
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.16) #11
...
7:                                                ; preds = %3
  tail call void @_ZSt19__throw_logic_errorPKc(ptr noundef nonnull @.str.15) #11
  unreachable
...
311:                                              ; preds = %183, %285, %278, %271, %215, %186
...
457:                                              ; preds = %144, %332, %344, %349, %361, %366, %428, %455, %439, %143
...
attributes #10 = { inlinehint mustprogress sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
