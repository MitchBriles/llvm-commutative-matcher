; ModuleID = '/home/mitch/Documents/PROJ/src/wkt1_generated_parser.c'
...
32:                                               ; preds = %25
  ...
  %37 = call ptr @malloc(i64 noundef %36) #10
...
69:                                               ; preds = %67
  %70 = call i32 @pj_wkt1_lex(ptr noundef nonnull %2, ptr noundef %0) #9
  br label %71
...
158:                                              ; preds = %155
  ...
  %160 = call ptr @malloc(i64 noundef %159) #10
...
163:                                              ; preds = %162, %155
  call void @pj_wkt1_error(ptr noundef %0, ptr noundef nonnull @.str) #9
  br label %167

164:                                              ; preds = %158
  %165 = call fastcc i32 @yysyntax_error(ptr noundef %6, ptr nonnull %160, ptr noundef %58, i32 noundef %156)
  call void @pj_wkt1_error(ptr noundef %0, ptr noundef nonnull %160) #9
  %166 = icmp eq i32 %165, 2
  br i1 %166, label %167, label %172

167:                                              ; preds = %25, %32, %164, %163, %155
  ...
  call void @pj_wkt1_error(ptr noundef %0, ptr noundef nonnull %168) #9
  br label %172

172:                                              ; preds = %54, %167, %164
...
declare i32 @pj_wkt1_lex(ptr noundef, ptr noundef) local_unnamed_addr #5

; Function Attrs: nofree norecurse nounwind sspstrong memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define internal fastcc range(i32 0, 3) i32 @yysyntax_error(ptr noundef nonnull captures(none) %0, ptr %1, ptr noundef nonnull readonly captures(none) %2, i32 noundef range(i32 -128, 128) %3) unnamed_addr #6 {
...
96:                                               ; preds = %57, %35, %32, %4, %90, %95, %94, %93, %92, %91
...
165:                                              ; preds = %81, %114, %110, %96
  %166 = phi i32 [ 2, %96 ], [ 1, %110 ], [ 0, %114 ], [ 2, %81 ]
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %5) #9
  ret i32 %166
}

declare void @pj_wkt1_error(ptr noundef, ptr noundef) local_unnamed_addr #5
...
attributes #6 = { nofree norecurse nounwind sspstrong memory(read, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
