; ModuleID = '/home/mitch/Documents/PROJ/src/projections/collg.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/collg.cpp"
...
define hidden noundef ptr @pj_collg(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL15collg_s_inverse5PJ_XYP8PJconsts, ptr %5, align 8, !tbaa !37
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL15collg_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL9des_collg, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z34pj_projection_specific_setup_collgP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL15collg_s_inverse5PJ_XYP8PJconsts, ptr %3, align 8, !tbaa !37
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL15collg_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
...
10:                                               ; preds = %3
  %11 = tail call double @asin(double noundef %7) #6, !tbaa !44
  br label %19
...
19:                                               ; preds = %16, %10
  %20 = phi double [ %11, %10 ], [ %18, %16 ]
  %21 = tail call double @sin(double noundef %20) #6, !tbaa !44
  %22 = fsub double 1.000000e+00, %21
  %23 = fcmp ugt double %22, 0.000000e+00
  br i1 %23, label %24, label %28

24:                                               ; preds = %19
  %25 = tail call double @sqrt(double noundef %22) #6, !tbaa !44
  %26 = fmul double %25, 0x3FF20DD750429B6D
  %27 = fdiv double %0, %26
  br label %28

28:                                               ; preds = %19, %24, %14
  %29 = phi double [ %20, %24 ], [ %7, %14 ], [ %20, %19 ]
  %30 = phi double [ %27, %24 ], [ 0.000000e+00, %14 ], [ 0.000000e+00, %19 ]
  %31 = insertvalue { double, double } poison, double %30, 0
  %32 = insertvalue { double, double } %31, double %29, 1
...
define internal { double, double } @_ZL15collg_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
...
7:                                                ; preds = %3
  %8 = tail call double @sqrt(double noundef %5) #6, !tbaa !44
  br label %9

9:                                                ; preds = %3, %7
  %10 = phi double [ %8, %7 ], [ 0.000000e+00, %3 ]
  %11 = fmul double %0, 0x3FF20DD750429B6D
  %12 = fmul double %11, %10
  %13 = fsub double 1.000000e+00, %10
  %14 = fmul double %13, 0x3FFC5BF891B4EF6B
  %15 = insertvalue { double, double } poison, double %12, 0
