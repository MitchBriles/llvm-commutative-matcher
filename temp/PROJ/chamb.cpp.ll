; ModuleID = '/home/mitch/Documents/PROJ/src/projections/chamb.cpp'
...
7:                                                ; preds = %1
  ...
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %2, i64 noundef 10, ptr noundef nonnull @.str.1, i32 noundef 1) #8
  ...
  %15 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %2, i64 noundef 10, ptr noundef nonnull @.str.2, i32 noundef 1) #8
  ...
  %27 = call double @sin(double noundef %24) #8, !tbaa !50
  %28 = getelementptr inbounds nuw i8, ptr %3, i64 24
  store double %27, ptr %28, align 8, !tbaa !52
  %29 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %2, i64 noundef 10, ptr noundef nonnull @.str.1, i32 noundef 2) #8
  ...
  %34 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %2, i64 noundef 10, ptr noundef nonnull @.str.2, i32 noundef 2) #8
  ...
  %44 = call double @cos(double noundef %43) #8, !tbaa !50
  %45 = getelementptr inbounds nuw i8, ptr %3, i64 80
  store double %44, ptr %45, align 8, !tbaa !51
  %46 = call double @sin(double noundef %43) #8, !tbaa !50
  %47 = getelementptr inbounds nuw i8, ptr %3, i64 88
  store double %46, ptr %47, align 8, !tbaa !52
  %48 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %2, i64 noundef 10, ptr noundef nonnull @.str.1, i32 noundef 3) #8
  ...
  %53 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %2, i64 noundef 10, ptr noundef nonnull @.str.2, i32 noundef 3) #8
  ...
  %63 = call double @cos(double noundef %62) #8, !tbaa !50
  %64 = getelementptr inbounds nuw i8, ptr %3, i64 144
  store double %63, ptr %64, align 8, !tbaa !51
  %65 = call double @sin(double noundef %62) #8, !tbaa !50
  ...
  %78 = call double @cos(double noundef %77) #8, !tbaa !50
...
89:                                               ; preds = %7
  ...
  %91 = call double @sin(double noundef %90) #8, !tbaa !50
  %92 = fmul double %77, 5.000000e-01
  %93 = call double @sin(double noundef %92) #8, !tbaa !50
  %94 = fmul double %71, %73
  %95 = fmul double %94, %93
  %96 = fmul double %93, %95
  %97 = call double @llvm.fmuladd.f64(double %91, double %91, double %96)
  %98 = call double @sqrt(double noundef %97) #8, !tbaa !50
...
109:                                              ; preds = %101
  %110 = call double @sin(double noundef %77) #8, !tbaa !50
  %111 = fmul double %73, %110
  %112 = fmul double %72, %73
  %113 = fneg double %78
  %114 = fmul double %112, %113
  %115 = call double @llvm.fmuladd.f64(double %71, double %74, double %114)
  %116 = call double @atan2(double noundef %111, double noundef %115) #8, !tbaa !50
  ...
  %130 = call double @cos(double noundef %129) #8, !tbaa !50
...
136:                                              ; preds = %109
  ...
  %138 = call double @sin(double noundef %137) #8, !tbaa !50
  %139 = fmul double %129, 5.000000e-01
  %140 = call double @sin(double noundef %139) #8, !tbaa !50
  ...
  %145 = call double @sqrt(double noundef %144) #8, !tbaa !50
...
157:                                              ; preds = %153
  %158 = call double @sin(double noundef %129) #8, !tbaa !50
  %159 = fmul double %125, %158
  %160 = fmul double %124, %125
  %161 = fneg double %130
  %162 = fmul double %160, %161
  %163 = call double @llvm.fmuladd.f64(double %123, double %126, double %162)
  %164 = call double @atan2(double noundef %159, double noundef %163) #8, !tbaa !50
  ...
  %178 = call double @cos(double noundef %177) #8, !tbaa !50
...
184:                                              ; preds = %157
  ...
  %186 = call double @sin(double noundef %185) #8, !tbaa !50
  %187 = fmul double %177, 5.000000e-01
  %188 = call double @sin(double noundef %187) #8, !tbaa !50
  ...
  %193 = call double @sqrt(double noundef %192) #8, !tbaa !50
...
205:                                              ; preds = %201
  %206 = call double @sin(double noundef %177) #8, !tbaa !50
  ...
  %212 = call double @atan2(double noundef %207, double noundef %211) #8, !tbaa !50
  ...
  %246 = call double @sin(double noundef %242) #8, !tbaa !50
  ...
  %260 = call double @cos(double noundef %242) #8, !tbaa !50
...
define internal { double, double } @_ZL15chamb_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %8 = tail call double @cos(double noundef %1) #8, !tbaa !50
  ...
  %20 = fsub double %0, %19
  %21 = tail call double @cos(double noundef %20) #8, !tbaa !50
...
32:                                               ; preds = %3
  ...
  %34 = tail call double @sin(double noundef %33) #8, !tbaa !50
  %35 = fmul double %20, 5.000000e-01
  %36 = tail call double @sin(double noundef %35) #8, !tbaa !50
  %37 = fmul double %8, %15
  %38 = fmul double %37, %36
  %39 = fmul double %36, %38
  %40 = tail call double @llvm.fmuladd.f64(double %34, double %34, double %39)
  %41 = tail call double @sqrt(double noundef %40) #8, !tbaa !50
...
55:                                               ; preds = %44
  %56 = tail call double @sin(double noundef %20) #8, !tbaa !50
  %57 = fmul double %8, %56
  %58 = fmul double %8, %17
  %59 = fneg double %21
  %60 = fmul double %58, %59
  %61 = tail call double @llvm.fmuladd.f64(double %15, double %7, double %60)
  %62 = tail call double @atan2(double noundef %57, double noundef %61) #8, !tbaa !50
  ...
  %77 = fsub double %0, %76
  %78 = tail call double @cos(double noundef %77) #8, !tbaa !50
...
84:                                               ; preds = %55
  ...
  %86 = tail call double @sin(double noundef %85) #8, !tbaa !50
  %87 = fmul double %77, 5.000000e-01
  %88 = tail call double @sin(double noundef %87) #8, !tbaa !50
  %89 = fmul double %8, %72
  %90 = fmul double %89, %88
  %91 = fmul double %88, %90
  %92 = tail call double @llvm.fmuladd.f64(double %86, double %86, double %91)
  %93 = tail call double @sqrt(double noundef %92) #8, !tbaa !50
...
105:                                              ; preds = %101
  %106 = tail call double @sin(double noundef %77) #8, !tbaa !50
  %107 = fmul double %8, %106
  %108 = fmul double %8, %74
  %109 = fneg double %78
  %110 = fmul double %108, %109
  %111 = tail call double @llvm.fmuladd.f64(double %72, double %7, double %110)
  %112 = tail call double @atan2(double noundef %107, double noundef %111) #8, !tbaa !50
  ...
  %128 = tail call double @cos(double noundef %127) #8, !tbaa !50
...
134:                                              ; preds = %105
  ...
  %136 = tail call double @sin(double noundef %135) #8, !tbaa !50
  %137 = fmul double %127, 5.000000e-01
  %138 = tail call double @sin(double noundef %137) #8, !tbaa !50
  ...
  %143 = tail call double @sqrt(double noundef %142) #8, !tbaa !50
...
155:                                              ; preds = %151
  %156 = tail call double @sin(double noundef %127) #8, !tbaa !50
  %157 = fmul double %8, %156
  %158 = fmul double %8, %124
  %159 = fneg double %128
  %160 = fmul double %158, %159
  %161 = tail call double @llvm.fmuladd.f64(double %122, double %7, double %160)
  %162 = tail call double @atan2(double noundef %157, double noundef %161) #8, !tbaa !50
  ...
  %187 = tail call double @cos(double noundef %186) #8, !tbaa !50
  %188 = tail call double @llvm.fmuladd.f64(double %45, double %187, double %168)
  %189 = tail call double @sin(double noundef %186) #8, !tbaa !50
  %190 = fneg double %45
  ...
  %208 = tail call double @cos(double noundef %207) #8, !tbaa !50
  %209 = tail call double @llvm.fmuladd.f64(double %178, double %208, double %188)
  %210 = tail call double @sin(double noundef %207) #8, !tbaa !50
  ...
  %228 = tail call double @cos(double noundef %227) #8, !tbaa !50
  %229 = tail call double @sin(double noundef %227) #8, !tbaa !50
