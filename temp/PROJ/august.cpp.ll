; ModuleID = '/home/mitch/Documents/PROJ/src/projections/august.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/august.cpp"
...
define hidden noundef ptr @pj_august(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL16august_s_forward5PJ_LPP8PJconsts, ptr %5, align 8, !tbaa !37
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL10des_august, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z35pj_projection_specific_setup_augustP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr null, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL16august_s_forward5PJ_LPP8PJconsts, ptr %3, align 8, !tbaa !37
...
define internal { double, double } @_ZL16august_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  ...
  %8 = tail call double @sqrt(double noundef %7) #6, !tbaa !44
  ...
  %12 = tail call double @sin(double noundef %9) #6, !tbaa !44
  %13 = fmul double %8, %12
  ...
  %26 = insertvalue { double, double } poison, double %21, 0
