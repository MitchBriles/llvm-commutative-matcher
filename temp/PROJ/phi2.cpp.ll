; ModuleID = '/home/mitch/Documents/PROJ/src/phi2.cpp'
...
14:                                               ; preds = %11
  %15 = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZ17pj_sinhpsi2tanphiP6pj_ctxddE3tol) #7
  %16 = icmp eq i32 %15, 0
...
24:                                               ; preds = %21
  %25 = tail call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZ17pj_sinhpsi2tanphiP6pj_ctxddE4tmax) #7
  %26 = icmp eq i32 %25, 0
...
40:                                               ; preds = %31
  %41 = tail call double @atanh(double noundef %2) #7, !tbaa !9
  %42 = fmul double %2, %41
  %43 = tail call double @exp(double noundef %42) #7, !tbaa !9
  %44 = fmul double %1, %43
  br label %47
...
52:                                               ; preds = %47
  ...
  %57 = tail call double @atanh(double noundef %56) #7, !tbaa !9
  %58 = fmul double %2, %57
  %59 = tail call double @sinh(double noundef %58) #7, !tbaa !9
...
77:                                               ; preds = %52
  ...
  %82 = tail call double @atanh(double noundef %81) #7, !tbaa !9
  %83 = fmul double %2, %82
  %84 = tail call double @sinh(double noundef %83) #7, !tbaa !9
...
102:                                              ; preds = %77
  ...
  %107 = tail call double @atanh(double noundef %106) #7, !tbaa !9
  %108 = fmul double %2, %107
  %109 = tail call double @sinh(double noundef %108) #7, !tbaa !9
...
127:                                              ; preds = %102
  ...
  %132 = tail call double @atanh(double noundef %131) #7, !tbaa !9
  %133 = fmul double %2, %132
  %134 = tail call double @sinh(double noundef %133) #7, !tbaa !9
...
152:                                              ; preds = %127
  ...
  %157 = tail call double @atanh(double noundef %156) #7, !tbaa !9
  %158 = fmul double %2, %157
  %159 = tail call double @sinh(double noundef %158) #7, !tbaa !9
...
178:                                              ; preds = %52, %77, %102, %127, %152, %177, %47
...
define noundef double @_Z7pj_phi2P6pj_ctxdd(ptr noundef %0, double noundef %1, double noundef %2) local_unnamed_addr #0 {
  ...
  %8 = tail call double @atan(double noundef %7) #7, !tbaa !9
  ret double %8
}
