; ModuleID = '/home/mitch/Documents/PROJ/src/projections/eck2.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/eck2.cpp"
...
define hidden noundef ptr @pj_eck2(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL14eck2_s_inverse5PJ_XYP8PJconsts, ptr %5, align 8, !tbaa !37
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14eck2_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL8des_eck2, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z33pj_projection_specific_setup_eck2P8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL14eck2_s_inverse5PJ_XYP8PJconsts, ptr %3, align 8, !tbaa !37
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14eck2_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
...
19:                                               ; preds = %3
  %20 = tail call double @asin(double noundef %9) #6, !tbaa !44
  br label %21
...
26:                                               ; preds = %21, %24, %14
  %27 = phi double [ %9, %14 ], [ %25, %24 ], [ %22, %21 ]
  %28 = fmul double %6, 0x3FDD7B6F52FAC55A
  %29 = fdiv double %0, %28
  %30 = insertvalue { double, double } poison, double %29, 0
  %31 = insertvalue { double, double } %30, double %27, 1
...
define internal { double, double } @_ZL14eck2_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  %4 = tail call double @llvm.fabs.f64(double %1)
  %5 = tail call double @sin(double noundef %4) #6, !tbaa !44
  %6 = tail call double @llvm.fmuladd.f64(double %5, double -3.000000e+00, double 4.000000e+00)
  %7 = tail call double @sqrt(double noundef %6) #6, !tbaa !44
  ...
  %13 = fmul double %0, 0x3FDD7B6F52FAC55A
  %14 = fmul double %13, %7
