; ModuleID = '/home/mitch/Documents/PROJ/src/projections/natearth2.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/natearth2.cpp"
...
define hidden noundef ptr @pj_natearth2(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL19natearth2_s_inverse5PJ_XYP8PJconsts, ptr %5, align 8, !tbaa !37
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL19natearth2_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL13des_natearth2, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z38pj_projection_specific_setup_natearth2P8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL19natearth2_s_inverse5PJ_XYP8PJconsts, ptr %3, align 8, !tbaa !37
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL19natearth2_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
...
8:                                                ; preds = %3, %5, %7
  %9 = phi double [ 0xBFF6C9A4865D0F30, %7 ], [ %1, %5 ], [ 0x3FF6C9A4865D0F30, %3 ]
  %10 = fneg double %9
  br label %14
...
11:                                               ; preds = %14
  %12 = add nsw i32 %15, -1
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %31, label %14, !llvm.loop !44

14:                                               ; preds = %8, %11
  %15 = phi i32 [ 100, %8 ], [ %12, %11 ]
  %16 = phi double [ %9, %8 ], [ %28, %11 ]
  %17 = fmul double %16, %16
  %18 = fmul double %17, %17
  %19 = fmul double %18, %18
  %20 = tail call double @llvm.fmuladd.f64(double %17, double 1.926000e-02, double -2.625000e-02)
  %21 = tail call double @llvm.fmuladd.f64(double %18, double -3.960000e-03, double %20)
  %22 = tail call double @llvm.fmuladd.f64(double %19, double %21, double 1.011830e+00)
  %23 = tail call double @llvm.fmuladd.f64(double %16, double %22, double %10)
  %24 = tail call double @llvm.fmuladd.f64(double %17, double 2.118600e-01, double -2.362500e-01)
  %25 = tail call double @llvm.fmuladd.f64(double %18, double -5.148000e-02, double %24)
  %26 = tail call double @llvm.fmuladd.f64(double %19, double %25, double 1.011830e+00)
  ...
  br i1 %30, label %33, label %11

31:                                               ; preds = %11
  %32 = load ptr, ptr %2, align 8, !tbaa !46
  tail call void @_Z22proj_context_errno_setP6pj_ctxi(ptr noundef %32, i32 noundef 2050)
  br label %33
...
33:                                               ; preds = %14, %31
  ...
  %37 = tail call double @llvm.fmuladd.f64(double %34, double -1.306300e-01, double 8.471900e-01)
  %38 = fmul double %36, %36
  %39 = tail call double @llvm.fmuladd.f64(double %34, double 5.494000e-02, double -4.515000e-02)
  %40 = tail call double @llvm.fmuladd.f64(double %35, double -2.326000e-02, double %39)
  %41 = tail call double @llvm.fmuladd.f64(double %36, double 3.310000e-03, double %40)
  %42 = tail call double @llvm.fmuladd.f64(double %38, double %41, double %37)
  %43 = fdiv double %0, %42
  %44 = insertvalue { double, double } poison, double %43, 0
  %45 = insertvalue { double, double } %44, double %28, 1
...
define internal { double, double } @_ZL19natearth2_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  ...
  %18 = fmul double %1, %17
  %19 = insertvalue { double, double } poison, double %13, 0
