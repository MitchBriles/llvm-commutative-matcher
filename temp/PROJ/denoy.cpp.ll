; ModuleID = '/home/mitch/Documents/PROJ/src/projections/denoy.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/denoy.cpp"
...
define hidden noundef ptr @pj_denoy(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL15denoy_s_forward5PJ_LPP8PJconsts, ptr %5, align 8, !tbaa !37
  br label %15
...
9:                                                ; preds = %6
  ...
  store ptr @_ZL9des_denoy, ptr %11, align 8, !tbaa !39
...
define hidden noundef ptr @_Z34pj_projection_specific_setup_denoyP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 112), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL15denoy_s_forward5PJ_LPP8PJconsts, ptr %3, align 8, !tbaa !37
  ret ptr %0
}
...
define internal { double, double } @_ZL15denoy_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  ...
  %12 = fmul double %1, %11
  %13 = fmul double %7, %12
  %14 = tail call double @cos(double noundef %13) #6, !tbaa !43
  %15 = fmul double %0, %14
  %16 = insertvalue { double, double } poison, double %15, 0
  %17 = insertvalue { double, double } %16, double %1, 1
