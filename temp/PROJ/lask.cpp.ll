; ModuleID = '/home/mitch/Documents/PROJ/src/projections/lask.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/lask.cpp"
...
define hidden noundef ptr @pj_lask(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
  %2 = icmp eq ptr %0, null
  br i1 %2, label %6, label %3

3:                                                ; preds = %1
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14lask_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !4
...
9:                                                ; preds = %6
  ...
  store ptr @_ZL8des_lask, ptr %11, align 8, !tbaa !39
...
define hidden noundef ptr @_Z33pj_projection_specific_setup_laskP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 112), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14lask_s_forward5PJ_LPP8PJconsts, ptr %2, align 8, !tbaa !4
