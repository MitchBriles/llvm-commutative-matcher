; ModuleID = '/home/mitch/Documents/PROJ/src/projections/wag2.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/wag2.cpp"
...
define hidden noundef ptr @pj_wag2(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL14wag2_s_inverse5PJ_XYP8PJconsts, ptr %5, align 8, !tbaa !37
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14wag2_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL8des_wag2, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z33pj_projection_specific_setup_wag2P8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL14wag2_s_inverse5PJ_XYP8PJconsts, ptr %3, align 8, !tbaa !37
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14wag2_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
...
define internal { double, double } @_ZL14wag2_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %5 = tail call double @cos(double noundef %4) #4, !tbaa !44
  %6 = fmul double %5, 9.248300e-01
  %7 = fdiv double %0, %6
  %8 = load ptr, ptr %2, align 8, !tbaa !45
  %9 = tail call double @sin(double noundef %4) #4, !tbaa !44
...
define internal { double, double } @_ZL14wag2_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %6 = tail call double @sin(double noundef %5) #4, !tbaa !44
  ...
  %10 = tail call double @cos(double noundef %8) #4, !tbaa !44
  %11 = fmul double %9, %10
