; ModuleID = '/home/mitch/Documents/PROJ/src/projections/tcea.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/tcea.cpp"
...
define hidden noundef ptr @pj_tcea(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
  %2 = icmp eq ptr %0, null
  br i1 %2, label %7, label %3

3:                                                ; preds = %1
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL14tcea_s_inverse5PJ_XYP8PJconsts, ptr %4, align 8, !tbaa !4
  %5 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14tcea_s_forward5PJ_LPP8PJconsts, ptr %5, align 8, !tbaa !37
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL8des_tcea, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z33pj_projection_specific_setup_tceaP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL14tcea_s_inverse5PJ_XYP8PJconsts, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL14tcea_s_forward5PJ_LPP8PJconsts, ptr %3, align 8, !tbaa !37
...
define internal { double, double } @_ZL14tcea_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #3 {
  ...
  %13 = tail call double @sqrt(double noundef %12) #6, !tbaa !46
  %14 = tail call double @sin(double noundef %9) #6, !tbaa !46
  %15 = fmul double %13, %14
  %16 = tail call double @asin(double noundef %15) #6, !tbaa !46
  %17 = tail call double @cos(double noundef %9) #6, !tbaa !46
  %18 = fmul double %13, %17
  %19 = tail call double @atan2(double noundef %10, double noundef %18) #6, !tbaa !46
  %20 = insertvalue { double, double } poison, double %19, 0
  %21 = insertvalue { double, double } %20, double %16, 1
...
define internal { double, double } @_ZL14tcea_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #3 {
  %4 = tail call double @cos(double noundef %1) #6, !tbaa !46
  %5 = tail call double @sin(double noundef %0) #6, !tbaa !46
  %6 = fmul double %4, %5
  %7 = getelementptr inbounds nuw i8, ptr %2, i64 488
  %8 = load double, ptr %7, align 8, !tbaa !44
  %9 = fdiv double %6, %8
  %10 = tail call double @tan(double noundef %1) #6, !tbaa !46
  %11 = tail call double @cos(double noundef %0) #6, !tbaa !46
  %12 = tail call double @atan2(double noundef %10, double noundef %11) #6, !tbaa !46
  %13 = getelementptr inbounds nuw i8, ptr %2, i64 448
  %14 = load double, ptr %13, align 8, !tbaa !45
  %15 = fsub double %12, %14
  %16 = fmul double %8, %15
  %17 = insertvalue { double, double } poison, double %9, 0
...
attributes #3 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(argmem: read, errnomem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
