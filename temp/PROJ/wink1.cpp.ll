; ModuleID = '/home/mitch/Documents/PROJ/src/projections/wink1.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/wink1.cpp"
...
8:                                                ; preds = %3
  ...
  store ptr @_ZL15wink1_s_inverse5PJ_XYP8PJconsts, ptr %18, align 8, !tbaa !43
  %19 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL15wink1_s_forward5PJ_LPP8PJconsts, ptr %19, align 8, !tbaa !44
  br label %29
...
23:                                               ; preds = %20
  ...
  store ptr @_ZL9des_wink1, ptr %25, align 8, !tbaa !46
...
6:                                                ; preds = %1
  ...
  store ptr @_ZL15wink1_s_inverse5PJ_XYP8PJconsts, ptr %16, align 8, !tbaa !43
  %17 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL15wink1_s_forward5PJ_LPP8PJconsts, ptr %17, align 8, !tbaa !44
  br label %18
...
define internal { double, double } @_ZL15wink1_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #4 {
  %4 = fmul double %0, 2.000000e+00
  %5 = getelementptr inbounds nuw i8, ptr %2, i64 88
  %6 = load ptr, ptr %5, align 8, !tbaa !4
  %7 = load double, ptr %6, align 8, !tbaa !40
  %8 = tail call double @cos(double noundef %1) #6, !tbaa !39
  %9 = fadd double %7, %8
  %10 = fdiv double %4, %9
...
; Function Attrs: mustprogress nofree norecurse nounwind sspstrong willreturn memory(read, inaccessiblemem: none, errnomem: readwrite) uwtable
define internal { double, double } @_ZL15wink1_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #4 {
...
!39 = !{!14, !14, i64 0}
!40 = !{!41, !15, i64 0}
!41 = !{!"_ZTSN12_GLOBAL__N_113pj_wink1_dataE", !15, i64 0}
!42 = !{!5, !15, i64 216}
!43 = !{!5, !7, i64 112}
!44 = !{!5, !7, i64 104}
!45 = !{!5, !10, i64 8}
