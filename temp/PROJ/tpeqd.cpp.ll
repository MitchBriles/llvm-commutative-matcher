; ModuleID = '/home/mitch/Documents/PROJ/src/projections/tpeqd.cpp'
...
30:                                               ; preds = %6
  ...
  %38 = tail call double @cos(double noundef %12) #7, !tbaa !47
  store double %38, ptr %2, align 8, !tbaa !48
  %39 = tail call double @cos(double noundef %20) #7, !tbaa !47
  %40 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store double %39, ptr %40, align 8, !tbaa !49
  %41 = tail call double @sin(double noundef %12) #7, !tbaa !47
  %42 = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double %41, ptr %42, align 8, !tbaa !50
  %43 = tail call double @sin(double noundef %20) #7, !tbaa !47
  ...
  %50 = tail call double @sin(double noundef %36) #7, !tbaa !47
  %51 = fmul double %49, %50
  %52 = getelementptr inbounds nuw i8, ptr %2, i64 32
  store double %51, ptr %52, align 8, !tbaa !54
  %53 = tail call double @cos(double noundef %36) #7, !tbaa !47
  %54 = fneg double %47
  %55 = tail call double @llvm.fmuladd.f64(double %54, double %53, double %45)
  %56 = tail call double @sin(double noundef %36) #7, !tbaa !47
  %57 = fmul double %39, %56
  %58 = fmul double %57, %57
  %59 = fmul double %55, %55
  %60 = fadd double %59, %58
  %61 = tail call double @llvm.sqrt.f64(double %60)
  %62 = tail call double @cos(double noundef %36) #7, !tbaa !47
  %63 = fmul double %49, %62
  %64 = tail call double @llvm.fmuladd.f64(double %41, double %43, double %63)
  %65 = tail call double @atan2(double noundef %61, double noundef %64) #7, !tbaa !47
  %66 = getelementptr inbounds nuw i8, ptr %2, i64 64
  store double %65, ptr %66, align 8, !tbaa !55
  %67 = fcmp oeq double %65, 0.000000e+00
...
70:                                               ; preds = %30
  ...
  %73 = tail call double @sin(double noundef %36) #7, !tbaa !47
  %74 = fmul double %39, %73
  %75 = tail call double @atan2(double noundef %74, double noundef %55) #7, !tbaa !47
  %76 = load ptr, ptr %0, align 8, !tbaa !42
  %77 = tail call double @sin(double noundef %75) #7, !tbaa !47
  %78 = fmul double %38, %77
  %79 = tail call noundef double @_Z5aasinP6pj_ctxd(ptr noundef %76, double noundef %78)
  %80 = tail call double @cos(double noundef %79) #7, !tbaa !47
  %81 = getelementptr inbounds nuw i8, ptr %2, i64 104
  store double %80, ptr %81, align 8, !tbaa !57
  %82 = tail call double @sin(double noundef %79) #7, !tbaa !47
  %83 = getelementptr inbounds nuw i8, ptr %2, i64 112
  store double %82, ptr %83, align 8, !tbaa !58
  %84 = load double, ptr %2, align 8, !tbaa !48
  %85 = tail call double @cos(double noundef %75) #7, !tbaa !47
  %86 = fmul double %84, %85
  %87 = load double, ptr %42, align 8, !tbaa !50
  %88 = tail call double @atan2(double noundef %86, double noundef %87) #7, !tbaa !47
  %89 = load double, ptr %72, align 8, !tbaa !56
  %90 = fsub double %88, %89
  %91 = tail call noundef double @_Z6adjlond(double noundef %90)
  %92 = getelementptr inbounds nuw i8, ptr %2, i64 120
  store double %91, ptr %92, align 8, !tbaa !59
  %93 = load double, ptr %37, align 8, !tbaa !45
  %94 = fmul double %93, 5.000000e-01
  store double %94, ptr %37, align 8, !tbaa !45
  %95 = tail call double @sin(double noundef %75) #7, !tbaa !47
  %96 = load double, ptr %42, align 8, !tbaa !50
  %97 = fmul double %95, %96
  %98 = tail call double @cos(double noundef %75) #7, !tbaa !47
  %99 = tail call double @atan2(double noundef %97, double noundef %98) #7, !tbaa !47
  ...
  %103 = load double, ptr %72, align 8, !tbaa !56
  %104 = tail call double @tan(double noundef %103) #7, !tbaa !47
  %105 = getelementptr inbounds nuw i8, ptr %2, i64 88
  store double %104, ptr %105, align 8, !tbaa !61
  %106 = tail call double @sin(double noundef %103) #7, !tbaa !47
  %107 = fdiv double 5.000000e-01, %106
  %108 = getelementptr inbounds nuw i8, ptr %2, i64 96
  store double %107, ptr %108, align 8, !tbaa !62
  %109 = load double, ptr %66, align 8, !tbaa !55
  %110 = fdiv double 5.000000e-01, %109
  %111 = getelementptr inbounds nuw i8, ptr %2, i64 56
  store double %110, ptr %111, align 8, !tbaa !63
  %112 = fmul double %109, %109
  store double %112, ptr %66, align 8, !tbaa !55
  %113 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL15tpeqd_s_inverse5PJ_XYP8PJconsts, ptr %113, align 8, !tbaa !64
  %114 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL15tpeqd_s_forward5PJ_LPP8PJconsts, ptr %114, align 8, !tbaa !65
  %115 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %115, align 8, !tbaa !66
  br label %116

116:                                              ; preds = %68, %70, %28, %4
  %117 = phi ptr [ %5, %4 ], [ %29, %28 ], [ %69, %68 ], [ %0, %70 ]
  ret ptr %117
}
...
define internal { double, double } @_ZL15tpeqd_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %8 = fadd double %0, %7
  %9 = tail call double @hypot(double noundef %1, double noundef %8) #7, !tbaa !47
  %10 = tail call double @cos(double noundef %9) #7, !tbaa !47
  %11 = fsub double %0, %7
  %12 = tail call double @hypot(double noundef %1, double noundef %11) #7, !tbaa !47
  %13 = tail call double @cos(double noundef %12) #7, !tbaa !47
  %14 = fadd double %10, %13
  %15 = fsub double %10, %13
  %16 = getelementptr inbounds nuw i8, ptr %5, i64 88
  %17 = load double, ptr %16, align 8, !tbaa !61
  %18 = fmul double %14, %17
  %19 = tail call double @atan2(double noundef %15, double noundef %18) #7, !tbaa !47
  %20 = load ptr, ptr %2, align 8, !tbaa !42
  %21 = tail call double @hypot(double noundef %18, double noundef %15) #7, !tbaa !47
  ...
  %29 = fneg double %19
  %30 = tail call double @sin(double noundef %28) #7, !tbaa !47
  %31 = tail call double @cos(double noundef %28) #7, !tbaa !47
  %32 = getelementptr inbounds nuw i8, ptr %5, i64 120
  %33 = load double, ptr %32, align 8, !tbaa !59
  %34 = fsub double %29, %33
  %35 = tail call double @cos(double noundef %34) #7, !tbaa !47
  ...
  %45 = tail call double @sin(double noundef %34) #7, !tbaa !47
  ...
  %53 = tail call double @atan2(double noundef %46, double noundef %52) #7, !tbaa !47
...
define internal { double, double } @_ZL15tpeqd_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %15 = fadd double %0, %14
  %16 = tail call double @cos(double noundef %15) #7, !tbaa !47
  ...
  %27 = fsub double %0, %26
  %28 = tail call double @cos(double noundef %27) #7, !tbaa !47
  ...
  %50 = tail call double @sin(double noundef %15) #7, !tbaa !47
  %51 = getelementptr inbounds nuw i8, ptr %5, i64 48
  %52 = load double, ptr %51, align 8, !tbaa !53
  %53 = tail call double @sin(double noundef %27) #7, !tbaa !47
  %54 = fneg double %53
