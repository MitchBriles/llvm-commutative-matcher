; ModuleID = '/home/mitch/Documents/PROJ/src/projections/putp6.cpp'
...
define internal { double, double } @_ZL15putp6_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %21 = fadd double %8, %10
  %22 = tail call double @log(double noundef %21) #8, !tbaa !52
  %23 = fneg double %22
...
define internal { double, double } @_ZL15putp6_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #3 {
  ...
  %17 = tail call double @log(double noundef %16) #8, !tbaa !52
  %18 = fneg double %17
...
26:                                               ; preds = %3
  ...
  %31 = tail call double @log(double noundef %30) #8, !tbaa !52
  %32 = fneg double %31
...
40:                                               ; preds = %26
  ...
  %45 = tail call double @log(double noundef %44) #8, !tbaa !52
  %46 = fneg double %45
...
54:                                               ; preds = %40
  ...
  %59 = tail call double @log(double noundef %58) #8, !tbaa !52
  %60 = fneg double %59
...
68:                                               ; preds = %54
  ...
  %73 = tail call double @log(double noundef %72) #8, !tbaa !52
  %74 = fneg double %73
...
82:                                               ; preds = %68
  ...
  %87 = tail call double @log(double noundef %86) #8, !tbaa !52
  %88 = fneg double %87
...
96:                                               ; preds = %82
  ...
  %101 = tail call double @log(double noundef %100) #8, !tbaa !52
  %102 = fneg double %101
...
110:                                              ; preds = %96
  ...
  %115 = tail call double @log(double noundef %114) #8, !tbaa !52
  %116 = fneg double %115
...
124:                                              ; preds = %110
  ...
  %129 = tail call double @log(double noundef %128) #8, !tbaa !52
  %130 = fneg double %129
...
138:                                              ; preds = %124
  ...
  %143 = tail call double @log(double noundef %142) #8, !tbaa !52
  %144 = fneg double %143
