; ModuleID = '/home/mitch/Documents/PROJ/src/projections/sterea.cpp'
...
4:                                                ; preds = %1
  ...
  %5 = tail call noalias dereferenceable_or_null(40) ptr @calloc(i64 noundef 1, i64 noundef 40) #8
...
20:                                               ; preds = %9
  ...
  %22 = call double @sin(double noundef %21) #7, !tbaa !42
  %23 = getelementptr inbounds nuw i8, ptr %5, i64 16
  store double %22, ptr %23, align 8, !tbaa !43
  %24 = call double @cos(double noundef %21) #7, !tbaa !42
...
18:                                               ; preds = %7
  ...
  %20 = call double @sin(double noundef %19) #7, !tbaa !42
  %21 = getelementptr inbounds nuw i8, ptr %3, i64 16
  store double %20, ptr %21, align 8, !tbaa !43
  %22 = call double @cos(double noundef %19) #7, !tbaa !42
...
define internal { double, double } @_ZL16sterea_e_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %8 = fdiv double %0, %7
  %9 = fdiv double %1, %7
  %10 = tail call double @hypot(double noundef %8, double noundef %9) #7, !tbaa !42
...
12:                                               ; preds = %3
  ...
  %15 = tail call double @atan2(double noundef %10, double noundef %14) #7, !tbaa !42
  %16 = fmul double %15, 2.000000e+00
  %17 = tail call double @sin(double noundef %16) #7, !tbaa !42
  %18 = tail call double @cos(double noundef %16) #7, !tbaa !42
  ...
  %27 = tail call double @asin(double noundef %26) #7, !tbaa !42
  %28 = fmul double %8, %17
  ...
  %34 = tail call double @atan2(double noundef %28, double noundef %33) #7, !tbaa !42
  br label %37
...
define internal { double, double } @_ZL16sterea_e_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  ...
  %13 = tail call double @sin(double noundef %12) #7, !tbaa !42
  %14 = tail call double @cos(double noundef %12) #7, !tbaa !42
  %15 = tail call double @cos(double noundef %11) #7, !tbaa !42
...
29:                                               ; preds = %3
  ...
  %37 = tail call double @sin(double noundef %11) #7, !tbaa !42
