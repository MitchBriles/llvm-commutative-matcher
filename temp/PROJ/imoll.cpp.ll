; ModuleID = '/home/mitch/Documents/PROJ/src/projections/imoll.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/imoll.cpp"
...
3:                                                ; preds = %1
  %4 = tail call noundef ptr @_Z34pj_projection_specific_setup_imollP8PJconsts(ptr noundef nonnull %0)
  br label %14
...
8:                                                ; preds = %5
  ...
  store ptr @_ZL9des_imoll, ptr %10, align 8, !tbaa !37
...
13:                                               ; preds = %10
  ...
  store double 0xBFFBECDE5DA115A9, ptr %15, align 8, !tbaa !44
  ...
  store double 0xBFFBECDE5DA115A9, ptr %17, align 8, !tbaa !46
...
24:                                               ; preds = %21
  ...
  store double 0x3FE0C152382D7365, ptr %26, align 8, !tbaa !44
  ...
  store double 0x3FE0C152382D7365, ptr %28, align 8, !tbaa !46
...
35:                                               ; preds = %32
  ...
  store double 0xC00657184AE74487, ptr %37, align 8, !tbaa !44
  ...
  store double 0xC00657184AE74487, ptr %39, align 8, !tbaa !46
...
46:                                               ; preds = %43
  ...
  store double 0xBFF0C152382D7365, ptr %48, align 8, !tbaa !44
  ...
  store double 0xBFF0C152382D7365, ptr %50, align 8, !tbaa !46
...
57:                                               ; preds = %54
  ...
  %62 = tail call fastcc noundef zeroext i1 @_ZL10setup_zoneP8PJconstsPN11pj_imoll_ns13pj_imoll_dataEiPFS0_S0_Eddd(ptr noundef nonnull %0, ptr noundef %2, i32 noundef 6, double noundef 0x40038C35418A5BF6, double noundef 0x40038C35418A5BF6)
  br i1 %62, label %115, label %63

63:                                               ; preds = %54, %46, %43, %35, %32, %24, %21, %13, %10, %6, %57
...
113:                                              ; preds = %63, %105, %109
  %114 = tail call noundef ptr @_Z21pj_default_destructorP8PJconstsi(ptr noundef nonnull %0, i32 noundef 4096)
  br label %154

115:                                              ; preds = %57
  %116 = tail call fastcc noundef double @_ZL19compute_zone_offsetPN11pj_imoll_ns13pj_imoll_dataEiiddd(ptr noundef %2, i32 noundef 3, i32 noundef 1, double noundef 0xC00657184AE74487, double noundef -1.000000e-10)
  ...
  %121 = tail call fastcc noundef double @_ZL19compute_zone_offsetPN11pj_imoll_ns13pj_imoll_dataEiiddd(ptr noundef %2, i32 noundef 2, i32 noundef 1, double noundef 0xBFE657184AE74487, double noundef 1.000000e-10)
  %122 = load ptr, ptr %19, align 8, !tbaa !42
  ...
  %126 = tail call fastcc noundef double @_ZL19compute_zone_offsetPN11pj_imoll_ns13pj_imoll_dataEiiddd(ptr noundef %2, i32 noundef 4, i32 noundef 1, double noundef 0xBFFBECDE5DA115A9, double noundef -1.000000e-10)
  ...
  %131 = tail call fastcc noundef double @_ZL19compute_zone_offsetPN11pj_imoll_ns13pj_imoll_dataEiiddd(ptr noundef %2, i32 noundef 5, i32 noundef 2, double noundef 0xBFD657184AE74487, double noundef -1.000000e-10)
  ...
  %136 = tail call fastcc noundef double @_ZL19compute_zone_offsetPN11pj_imoll_ns13pj_imoll_dataEiiddd(ptr noundef %2, i32 noundef 6, i32 noundef 2, double noundef 0x3FF657184AE74487, double noundef -1.000000e-10)
  ...
  %142 = tail call fastcc noundef double @_ZL23compute_zone_x_boundaryP8PJconstsdd(ptr noundef nonnull %0, double noundef 0xBFE657184AE74487, double noundef 1.000000e-10)
  %143 = getelementptr inbounds nuw i8, ptr %2, i64 48
  store double %142, ptr %143, align 8, !tbaa !48
  %144 = tail call fastcc noundef double @_ZL23compute_zone_x_boundaryP8PJconstsdd(ptr noundef nonnull %0, double noundef 0xBFFBECDE5DA115A9, double noundef -1.000000e-10)
  %145 = getelementptr inbounds nuw i8, ptr %2, i64 56
  store double %144, ptr %145, align 8, !tbaa !50
  %146 = tail call fastcc noundef double @_ZL23compute_zone_x_boundaryP8PJconstsdd(ptr noundef nonnull %0, double noundef 0xBFD657184AE74487, double noundef -1.000000e-10)
  %147 = getelementptr inbounds nuw i8, ptr %2, i64 64
  store double %146, ptr %147, align 8, !tbaa !51
  %148 = tail call fastcc noundef double @_ZL23compute_zone_x_boundaryP8PJconstsdd(ptr noundef nonnull %0, double noundef 0x3FF657184AE74487, double noundef -1.000000e-10)
  ...
  store ptr @_ZL15imoll_s_inverse5PJ_XYP8PJconsts, ptr %150, align 8, !tbaa !53
  %151 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL15imoll_s_forward5PJ_LPP8PJconsts, ptr %151, align 8, !tbaa !54
  %152 = getelementptr inbounds nuw i8, ptr %0, i64 152
  store ptr @_ZL19pj_imoll_destructorP8PJconstsi, ptr %152, align 8, !tbaa !47
...
16:                                               ; preds = %14
  ...
  %18 = select i1 %17, i64 5, i64 4
  br label %19

19:                                               ; preds = %9, %12, %14, %16
  %20 = phi i64 [ %11, %9 ], [ 2, %12 ], [ 3, %14 ], [ %18, %16 ]
...
33:                                               ; preds = %19
  %34 = fcmp ugt double %5, 0xBFE657184AE74487
  %35 = zext i1 %34 to i64
  br label %43

36:                                               ; preds = %19
  %37 = fcmp ugt double %5, 0xBFFBECDE5DA115A9
  br i1 %37, label %38, label %43

38:                                               ; preds = %36
  %39 = fcmp ugt double %5, 0xBFD657184AE74487
  br i1 %39, label %40, label %43

40:                                               ; preds = %38
  %41 = fcmp ugt double %5, 0x3FF657184AE74487
  %42 = select i1 %41, i64 5, i64 4
  br label %43

43:                                               ; preds = %33, %36, %38, %40
  %44 = phi i64 [ %35, %33 ], [ 2, %36 ], [ 3, %38 ], [ %42, %40 ]
...
29:                                               ; preds = %11, %23, %28, %15, %19, %27
  %30 = phi i32 [ 5, %23 ], [ 4, %19 ], [ 3, %15 ], [ 2, %11 ], [ 6, %27 ], [ 1, %28 ]
  %31 = add nsw i32 %30, -1
...
50:                                               ; preds = %29
  ...
  %52 = fcmp ole double %49, 0xBFE657184AD98617
  %53 = and i1 %51, %52
...
57:                                               ; preds = %29
  %58 = fcmp oge double %49, 0xBFE657184AF502F7
  %59 = fcmp ole double %49, 0x400921FB54479CB4
  %60 = and i1 %58, %59
...
64:                                               ; preds = %29
  %65 = fcmp oge double %49, 0xC00921FB54479CB4
  %66 = fcmp ole double %49, 0xBFFBECDE5D9A3671
  %67 = and i1 %65, %66
  %68 = fcmp ole double %45, 1.000000e-10
  %69 = select i1 %67, i1 %68, i1 false
  %70 = freeze i1 %69
  br i1 %70, label %93, label %94

71:                                               ; preds = %29
  %72 = fcmp oge double %49, 0xBFFBECDE5DA7F4E1
  %73 = fcmp ole double %49, 0xBFD657184ACBC7A7
  %74 = and i1 %72, %73
...
78:                                               ; preds = %29
  %79 = fcmp oge double %49, 0xBFD657184B02C167
  %80 = fcmp ole double %49, 0x3FF657184AEE23BF
  %81 = and i1 %79, %80
...
86:                                               ; preds = %29
  %87 = fcmp oge double %49, 0x3FF657184AE0654F
...
93:                                               ; preds = %78, %71, %64, %57, %50, %86
  br label %94

94:                                               ; preds = %78, %71, %64, %57, %50, %93, %3, %86
...
14:                                               ; preds = %12
  ...
  %16 = select i1 %15, i64 5, i64 4
  br label %17

17:                                               ; preds = %14, %12, %10, %7
  %18 = phi i64 [ %9, %7 ], [ 2, %10 ], [ 3, %12 ], [ %16, %14 ]
...
!47 = !{!5, !7, i64 152}
!48 = !{!49, !15, i64 48}
!49 = !{!"_ZTSN11pj_imoll_ns13pj_imoll_dataE", !8, i64 0, !15, i64 48, !15, i64 56, !15, i64 64, !15, i64 72}
!50 = !{!49, !15, i64 56}
!51 = !{!49, !15, i64 64}
!52 = !{!49, !15, i64 72}
!53 = !{!5, !7, i64 112}
