; ModuleID = '/home/mitch/Documents/PROJ/src/projections/spilhaus.cpp'
...
83:                                               ; preds = %77, %80
  ...
  %84 = call double @cos(double noundef %73) #13, !tbaa !55
  %85 = getelementptr inbounds nuw i8, ptr %5, i64 40
  store double %84, ptr %85, align 8, !tbaa !56
  %86 = call double @sin(double noundef %73) #13, !tbaa !55
  ...
  %91 = call double @cos(double noundef %90) #13, !tbaa !55
  %92 = fneg double %91
  %93 = call double @cos(double noundef %59) #13, !tbaa !55
  ...
  %98 = call double @sqrt(double noundef %97) #13, !tbaa !55
  store double %98, ptr %5, align 8, !tbaa !59
  %99 = call double @tan(double noundef %59) #13, !tbaa !55
  %100 = call double @sin(double noundef %90) #13, !tbaa !55
  %101 = fneg double %100
  %102 = call double @atan2(double noundef %99, double noundef %101) #13, !tbaa !55
  %103 = getelementptr inbounds nuw i8, ptr %5, i64 24
  store double %102, ptr %103, align 8, !tbaa !60
  %104 = call double @sin(double noundef %59) #13, !tbaa !55
  %105 = fneg double %104
  %106 = call double @tan(double noundef %90) #13, !tbaa !55
  %107 = fneg double %106
  %108 = call double @atan2(double noundef %105, double noundef %107) #13, !tbaa !55
...
133:                                              ; preds = %126
  ...
  %135 = add i64 %134, 1
  call void @_ZdlPvm(ptr noundef %128, i64 noundef %135) #14
  br label %136
...
define internal { double, double } @_ZL16spilhaus_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  ...
  %7 = tail call double @cos(double noundef %6) #13, !tbaa !55
  %8 = tail call double @sin(double noundef %6) #13, !tbaa !55
  %9 = getelementptr inbounds nuw i8, ptr %5, i64 24
  %10 = load double, ptr %9, align 8, !tbaa !60
  %11 = fsub double %0, %10
  %12 = tail call double @cos(double noundef %11) #13, !tbaa !55
  %13 = tail call double @sin(double noundef %11) #13, !tbaa !55
  ...
  %31 = tail call double @atan2(double noundef %25, double noundef %30) #13, !tbaa !55
...
define internal { double, double } @_ZL16spilhaus_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  ...
  %32 = tail call double @cos(double noundef %31) #13, !tbaa !55
  %33 = tail call double @sin(double noundef %31) #13, !tbaa !55
  %34 = getelementptr inbounds nuw i8, ptr %5, i64 16
  %35 = load double, ptr %34, align 8, !tbaa !61
  %36 = fsub double %30, %35
  %37 = tail call double @cos(double noundef %36) #13, !tbaa !55
  %38 = tail call double @sin(double noundef %36) #13, !tbaa !55
...
attributes #4 = { inlinehint mustprogress sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
