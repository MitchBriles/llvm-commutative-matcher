; ModuleID = '/home/mitch/Documents/PROJ/src/proj_mdist.cpp'
...
define hidden noalias noundef ptr @_Z14proj_mdist_inid(double noundef %0) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 160, ptr nonnull %2) #9
...
70:                                               ; preds = %45, %50, %16
  ...
  %78 = fsub double %77, %1
  %79 = tail call double @sqrt(double noundef %21) #9, !tbaa !16
...
attributes #4 = { mustprogress nofree norecurse nounwind sspstrong memory(argmem: read, errnomem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
