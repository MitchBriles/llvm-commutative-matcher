; ModuleID = '/home/mitch/Documents/PROJ/src/filemanager.cpp'
...
28:                                               ; preds = %23
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %12) #32, !noalias !21
...
42:                                               ; preds = %37, %39, %41
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %12) #32, !noalias !21
...
52:                                               ; preds = %42
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %11) #32, !noalias !24
...
67:                                               ; preds = %66, %64, %62
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %11) #32, !noalias !24
...
131:                                              ; preds = %23
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %10) #32, !noalias !29
...
145:                                              ; preds = %140, %142, %144
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %10) #32, !noalias !29
...
168:                                              ; preds = %160
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %9) #32, !noalias !32
...
182:                                              ; preds = %181, %179, %177
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %9) #32, !noalias !32
...
250:                                              ; preds = %246
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %8) #32, !noalias !35
...
262:                                              ; preds = %257, %259, %261
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %8) #32, !noalias !35
...
272:                                              ; preds = %262
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %7) #32, !noalias !38
...
287:                                              ; preds = %286, %284, %282
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %7) #32, !noalias !38
...
define hidden noundef i64 @_ZN5osgeo4proj9FileStdio4readEPvm(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(96) %0, ptr noundef writeonly captures(none) %1, i64 noundef %2) unnamed_addr #9 align 2 {
...
; Function Attrs: mustprogress nofree nounwind sspstrong uwtable
define hidden noundef i64 @_ZN5osgeo4proj9FileStdio5writeEPKvm(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(96) %0, ptr noundef readonly captures(none) %1, i64 noundef %2) unnamed_addr #9 align 2 {
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 88
  %5 = load ptr, ptr %4, align 8, !tbaa !45
...
65:                                               ; preds = %13, %17, %21, %25, %29, %33, %37, %41, %45, %49, %10, %7, %53
...
22:                                               ; preds = %18
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %3) #32, !noalias !108
...
38:                                               ; preds = %33, %35, %37
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %3) #32, !noalias !108
...
197:                                              ; preds = %191
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %3) #32, !noalias !116
...
213:                                              ; preds = %212, %210, %208
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %3) #32, !noalias !116
...
233:                                              ; preds = %226
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %2) #32, !noalias !119
...
249:                                              ; preds = %248, %246, %244
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %2) #32, !noalias !119
...
428:                                              ; preds = %269, %352, %398, %391, %422, %419
...
452:                                              ; preds = %363, %383, %414, %418, %417, %409, %438, %450, %441, %440, %426, %394, %378, %304
...
14:                                               ; preds = %12, %1
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %5) #32, !noalias !127
...
37:                                               ; preds = %36, %34, %32
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %6) #32, !noalias !127
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %7) #32, !noalias !127
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %8) #32, !noalias !127
...
110:                                              ; preds = %107, %104
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %8) #32, !noalias !127
...
119:                                              ; preds = %116, %113
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %7) #32, !noalias !127
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %6) #32, !noalias !127
...
164:                                              ; preds = %160
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %9) #32, !noalias !127
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %3) #32, !noalias !135
...
178:                                              ; preds = %177, %175, %173
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %3) #32, !noalias !135
...
228:                                              ; preds = %225, %222
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %9) #32, !noalias !127
  br label %231
...
267:                                              ; preds = %262, %259
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %5) #32, !noalias !127
  br label %265

268:                                              ; preds = %18, %240, %253
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %5) #32, !noalias !127
...
591:                                              ; preds = %356, %356, %348, %348, %345, %345, %353, %353, %362, %362, %438, %587
...
690:                                              ; preds = %689
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %29) #32
...
696:                                              ; preds = %693
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %31) #32
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %33) #32
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %34) #32
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %36) #32
...
704:                                              ; preds = %696
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %37) #32
...
733:                                              ; preds = %727, %730
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %37) #32
...
751:                                              ; preds = %747
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %38) #32
...
864:                                              ; preds = %858, %861
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %38) #32
  br label %867
...
867:                                              ; preds = %743, %747, %864, %736, %735
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %36) #32
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %35) #32
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %34) #32
...
876:                                              ; preds = %870, %873
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %33) #32
...
894:                                              ; preds = %888, %891
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %31) #32
  br label %941

895:                                              ; preds = %835, %837, %865, %821
...
988:                                              ; preds = %999, %997, %978, %951, %948, %1019, %1018
...
1004:                                             ; preds = %941, %1001
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %39) #32
...
1006:                                             ; preds = %1004
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %39) #32
...
1049:                                             ; preds = %1020, %1030, %1045, %1048
...
1058:                                             ; preds = %1052, %1055
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %29) #32
  br label %1074

1059:                                             ; preds = %939, %937, %1016, %988, %924
...
1074:                                             ; preds = %609, %609, %600, %600, %591, %591, %597, %597, %43, %587, %603, %603, %1058, %689
...
1104:                                             ; preds = %1098, %1100
  ret void

1105:                                             ; preds = %817, %492, %202, %1073, %584, %339
...
98:                                               ; preds = %226, %534, %562, %559, %529, %480, %478, %476, %428, %422, %351, %349, %347, %345, %217
...
226:                                              ; preds = %222, %109, %109, %45, %45, %106, %106, %115, %115, %194
...
534:                                              ; preds = %291, %226, %96, %529, %432, %532
...
588:                                              ; preds = %276, %287, %525, %424, %400, %208, %102, %98
...
18:                                               ; preds = %12
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %3) #32, !noalias !167
...
35:                                               ; preds = %30, %32, %34
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %3) #32, !noalias !167
  br label %40
...
define linkonce_odr noundef zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef %1) local_unnamed_addr #19 comdat personality ptr @__gxx_personality_v0 {
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 8
...
attributes #9 = { mustprogress nofree nounwind sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #19 = { inlinehint mustprogress nounwind sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #24 = { mustprogress noinline nounwind sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
