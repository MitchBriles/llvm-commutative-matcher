; ModuleID = '/home/mitch/Documents/PROJ/src/projections/vandg2.cpp'
...
3:                                                ; preds = %1
  %4 = tail call noalias dereferenceable_or_null(4) ptr @calloc(i64 noundef 1, i64 noundef 4) #7
...
11:                                               ; preds = %3
  %12 = tail call double @sqrt(double noundef %9) #8, !tbaa !43
  br label %13
...
31:                                               ; preds = %23
  ...
  %37 = tail call double @sqrt(double noundef %36) #8, !tbaa !43
...
39:                                               ; preds = %23
  ...
  %54 = tail call double @sqrt(double noundef %53) #8, !tbaa !43
  br label %55
