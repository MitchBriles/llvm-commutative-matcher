; ModuleID = '/home/mitch/Documents/PROJ/src/projections/comill.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/comill.cpp"
...
define hidden noundef ptr @pj_comill(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL16comill_s_inverse5PJ_XYP8PJconsts, ptr %5, align 8, !tbaa !37
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL16comill_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL10des_comill, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z35pj_projection_specific_setup_comillP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL16comill_s_inverse5PJ_XYP8PJconsts, ptr %3, align 8, !tbaa !37
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL16comill_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
...
8:                                                ; preds = %3, %5, %7
  %9 = phi double [ 0xBFFE290B9B071206, %7 ], [ %1, %5 ], [ 0x3FFE290B9B071206, %3 ]
  %10 = fneg double %9
  br label %14
...
11:                                               ; preds = %14
  %12 = add nsw i32 %15, -1
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %27, label %14, !llvm.loop !44

14:                                               ; preds = %8, %11
  %15 = phi i32 [ 100, %8 ], [ %12, %11 ]
  %16 = phi double [ %9, %8 ], [ %24, %11 ]
  %17 = fmul double %16, %16
  %18 = tail call double @llvm.fmuladd.f64(double %17, double -3.054000e-02, double 1.604000e-01)
  %19 = tail call double @llvm.fmuladd.f64(double %17, double %18, double 0x3FEFAFB7E90FF972)
  %20 = tail call double @llvm.fmuladd.f64(double %16, double %19, double %10)
  %21 = tail call double @llvm.fmuladd.f64(double %17, double -1.527000e-01, double 0x3FDECBFB15B573EA)
  %22 = tail call double @llvm.fmuladd.f64(double %17, double %21, double 0x3FEFAFB7E90FF972)
...
29:                                               ; preds = %14, %27
  %30 = insertvalue { double, double } poison, double %0, 0
  %31 = insertvalue { double, double } %30, double %24, 1
...
define internal { double, double } @_ZL16comill_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  ...
  %7 = fmul double %1, %6
  %8 = insertvalue { double, double } poison, double %0, 0
