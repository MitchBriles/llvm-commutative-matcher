; ModuleID = '/home/mitch/Documents/PROJ/src/projections/cc.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/cc.cpp"
...
define hidden noundef ptr @pj_cc(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL12cc_s_inverse5PJ_XYP8PJconsts, ptr %5, align 8, !tbaa !37
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL12cc_s_forward5PJ_LPP8PJconsts, ptr %6, align 8, !tbaa !38
  br label %16
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL6des_cc, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z31pj_projection_specific_setup_ccP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL12cc_s_inverse5PJ_XYP8PJconsts, ptr %3, align 8, !tbaa !37
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL12cc_s_forward5PJ_LPP8PJconsts, ptr %4, align 8, !tbaa !38
  ret ptr %0
}
...
define internal { double, double } @_ZL12cc_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr readnone captures(none) %2) #3 {
  %4 = tail call double @atan(double noundef %1) #6, !tbaa !44
  %5 = insertvalue { double, double } poison, double %0, 0
...
10:                                               ; preds = %3
  %11 = tail call double @tan(double noundef %1) #6, !tbaa !44
  br label %12

12:                                               ; preds = %10, %8
  %13 = phi double [ 0.000000e+00, %8 ], [ %11, %10 ]
  %14 = phi double [ 0.000000e+00, %8 ], [ %0, %10 ]
