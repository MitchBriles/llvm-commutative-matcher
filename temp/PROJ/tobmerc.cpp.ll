; ModuleID = '/home/mitch/Documents/PROJ/src/projections/tobmerc.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/tobmerc.cpp"
...
define hidden noundef ptr @pj_tobmerc(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
  %2 = icmp eq ptr %0, null
  br i1 %2, label %6, label %3

3:                                                ; preds = %1
  %4 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL17tobmerc_s_inverse5PJ_XYP8PJconsts, ptr %4, align 8, !tbaa !4
  %5 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL17tobmerc_s_forward5PJ_LPP8PJconsts, ptr %5, align 8, !tbaa !37
  br label %15
...
9:                                                ; preds = %6
  ...
  store ptr @_ZL11des_tobmerc, ptr %11, align 8, !tbaa !39
...
define hidden noundef ptr @_Z36pj_projection_specific_setup_tobmercP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL17tobmerc_s_inverse5PJ_XYP8PJconsts, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL17tobmerc_s_forward5PJ_LPP8PJconsts, ptr %3, align 8, !tbaa !37
  ret ptr %0
}
...
define internal { double, double } @_ZL17tobmerc_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #3 {
  ...
  %14 = insertvalue { double, double } %13, double %8, 1
...
8:                                                ; preds = %3
  %9 = tail call double @cos(double noundef %1) #6, !tbaa !44
  %10 = getelementptr inbounds nuw i8, ptr %2, i64 488
  %11 = load double, ptr %10, align 8, !tbaa !43
  %12 = fmul double %0, %11
  %13 = fmul double %9, %12
  %14 = fmul double %9, %13
  %15 = tail call double @tan(double noundef %1) #6, !tbaa !44
  %16 = tail call double @asinh(double noundef %15) #6, !tbaa !44
  %17 = fmul double %11, %16
  br label %18

18:                                               ; preds = %8, %6
  %19 = phi double [ 0.000000e+00, %6 ], [ %17, %8 ]
  %20 = phi double [ 0.000000e+00, %6 ], [ %14, %8 ]
