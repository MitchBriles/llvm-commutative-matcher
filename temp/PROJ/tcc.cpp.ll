; ModuleID = '/home/mitch/Documents/PROJ/src/projections/tcc.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/tcc.cpp"
...
define hidden noundef ptr @pj_tcc(ptr noundef writeonly captures(address_is_null, ret: address, provenance) %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  ...
  store ptr @_ZL13tcc_s_forward5PJ_LPP8PJconsts, ptr %5, align 8, !tbaa !37
...
10:                                               ; preds = %7
  ...
  store ptr @_ZL7des_tcc, ptr %12, align 8, !tbaa !40
...
define hidden noundef ptr @_Z32pj_projection_specific_setup_tccP8PJconsts(ptr noundef returned writeonly captures(ret: address, provenance) initializes((104, 120), (216, 224)) %0) local_unnamed_addr #1 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %2, align 8, !tbaa !4
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL13tcc_s_forward5PJ_LPP8PJconsts, ptr %3, align 8, !tbaa !37
...
define internal { double, double } @_ZL13tcc_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  %4 = tail call double @cos(double noundef %1) #5, !tbaa !44
  %5 = tail call double @sin(double noundef %0) #5, !tbaa !44
  %6 = fmul double %4, %5
  %7 = fneg double %6
...
12:                                               ; preds = %3
  %13 = tail call double @sqrt(double noundef %8) #5, !tbaa !44
  %14 = fdiv double %6, %13
  %15 = tail call double @tan(double noundef %1) #5, !tbaa !44
  %16 = tail call double @cos(double noundef %0) #5, !tbaa !44
  %17 = tail call double @atan2(double noundef %15, double noundef %16) #5, !tbaa !44
  br label %18

18:                                               ; preds = %12, %10
  %19 = phi double [ 0.000000e+00, %10 ], [ %17, %12 ]
  %20 = phi double [ 0.000000e+00, %10 ], [ %14, %12 ]
