; ModuleID = '/home/mitch/Documents/PROJ/src/trans_bounds.cpp'
...
26:                                               ; preds = %21
  %27 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %22, ptr noundef nonnull dereferenceable(5) @.str.3) #19
  %28 = icmp eq i32 %27, 0
  %29 = icmp eq i32 %2, 0
  %30 = or i1 %29, %28
...
47:                                               ; preds = %41
  ...
  %51 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %45) #20
...
59:                                               ; preds = %52
  ...
  %65 = call noundef ptr %64(ptr noundef nonnull align 8 dereferenceable(8) %61) #18
...
30:                                               ; preds = %24
  %31 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %25) #18
...
49:                                               ; preds = %42
  ...
  %53 = call noundef zeroext i1 @_ZN5osgeo4proj8internal9ends_withERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES9_(ptr noundef nonnull align 8 dereferenceable(32) %10, ptr noundef nonnull align 8 dereferenceable(32) %11) #18
...
86:                                               ; preds = %71
  ...
  %88 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %25) #18
...
106:                                              ; preds = %99
  ...
  %110 = call noundef zeroext i1 @_ZN5osgeo4proj8internal9ends_withERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES9_(ptr noundef nonnull align 8 dereferenceable(32) %12, ptr noundef nonnull align 8 dereferenceable(32) %13) #18
...
148:                                              ; preds = %143
  %149 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %144) #18
...
176:                                              ; preds = %171
  ...
  %178 = add i64 %177, 1
  call void @_ZdlPvm(ptr noundef %167, i64 noundef %178) #21
  br label %179
...
180:                                              ; preds = %179
  ...
  %182 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %144) #18
...
209:                                              ; preds = %204
  ...
  %211 = add i64 %210, 1
  call void @_ZdlPvm(ptr noundef %200, i64 noundef %211) #21
  br label %212
...
237:                                              ; preds = %233
  ...
  %239 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %238, ptr noundef nonnull dereferenceable(4) @.str.12) #19
  %240 = icmp eq i32 %239, 0
  br i1 %240, label %245, label %241

241:                                              ; preds = %237
  %242 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %238, ptr noundef nonnull dereferenceable(4) @.str.13) #19
  %243 = icmp eq i32 %242, 0
  %244 = zext i1 %243 to i32
  br label %245

245:                                              ; preds = %237, %241, %233
  %246 = phi i32 [ -1, %233 ], [ 1, %237 ], [ %244, %241 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %16) #18
  br label %247

247:                                              ; preds = %220, %232, %245, %213, %71, %128, %179, %212
...
30:                                               ; preds = %25
  %31 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %26, ptr noundef nonnull dereferenceable(5) @.str.3) #19
  %32 = icmp eq i32 %31, 0
  %33 = icmp eq i32 %2, 0
  %34 = or i1 %33, %32
...
72:                                               ; preds = %66
  ...
  %76 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %70) #20
...
77:                                               ; preds = %72
  ...
  %80 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %70) #20
...
81:                                               ; preds = %77, %72, %66
  ...
  %88 = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTISt9exception) #18
...
90:                                               ; preds = %81
  ...
  %96 = call noundef ptr %95(ptr noundef nonnull align 8 dereferenceable(8) %92) #18
...
1604:                                             ; preds = %1301, %1598, %1347, %1247
...
1781:                                             ; preds = %1780, %152, %119, %1021, %110
  ...
  call void @_ZdlPvm(ptr noundef nonnull %80, i64 noundef %70) #21
  br label %1787
...
1794:                                             ; preds = %1787
  ...
  call void @_ZdlPvm(ptr noundef nonnull %1791, i64 noundef %1797) #21
  br label %1798

1798:                                             ; preds = %1787, %1794
...
1800:                                             ; preds = %1798
  ...
  call void @_ZdlPvm(ptr noundef nonnull %1789, i64 noundef %1803) #21
  br label %1832

1804:                                             ; preds = %135, %1026, %1740, %1064, %121, %113
...
declare noundef zeroext i1 @_ZN5osgeo4proj8internal9ends_withERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES9_(ptr noundef nonnull align 8 dereferenceable(32), ptr noundef nonnull align 8 dereferenceable(32)) local_unnamed_addr #9
