; ModuleID = '/home/mitch/Documents/PROJ/src/projections/oea.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/oea.cpp"
...
3:                                                ; preds = %1
  %4 = tail call noundef ptr @_Z32pj_projection_specific_setup_oeaP8PJconsts(ptr noundef nonnull %0)
  br label %14
...
8:                                                ; preds = %5
  ...
  store ptr @_ZL7des_oea, ptr %10, align 8, !tbaa !37
...
26:                                               ; preds = %17
  ...
  store double %46, ptr %47, align 8, !tbaa !56
  ...
  store ptr @_ZL13oea_s_forward5PJ_LPP8PJconsts, ptr %50, align 8, !tbaa !58
  %51 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL13oea_s_inverse5PJ_XYP8PJconsts, ptr %51, align 8, !tbaa !59
  %52 = getelementptr inbounds nuw i8, ptr %0, i64 216
  store double 0.000000e+00, ptr %52, align 8, !tbaa !60
  br label %53

53:                                               ; preds = %26, %24, %15, %4
  %54 = phi ptr [ %5, %4 ], [ %16, %15 ], [ %25, %24 ], [ %0, %26 ]
  ret ptr %54
}
...
define internal { double, double } @_ZL13oea_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %9 = tail call double @sin(double noundef %0) #6, !tbaa !49
  %10 = fmul double %6, %9
  ...
  %20 = load double, ptr %5, align 8, !tbaa !47
  %21 = fadd double %19, %20
  %22 = load ptr, ptr %2, align 8, !tbaa !42
  %23 = load double, ptr %13, align 8, !tbaa !50
  %24 = load double, ptr %11, align 8, !tbaa !51
  %25 = fmul double %6, %24
  %26 = fmul double %8, %25
  ...
  %30 = tail call double @sin(double noundef %29) #6, !tbaa !49
  %31 = load ptr, ptr %2, align 8, !tbaa !42
  %32 = tail call double @sin(double noundef %21) #6, !tbaa !49
  %33 = fmul double %30, %32
  %34 = tail call noundef double @_Z5aasinP6pj_ctxd(ptr noundef %31, double noundef %33)
  %35 = load ptr, ptr %2, align 8, !tbaa !42
  %36 = tail call double @cos(double noundef %21) #6, !tbaa !49
  %37 = fmul double %30, %36
  %38 = tail call double @cos(double noundef %34) #6, !tbaa !49
  %39 = fmul double %37, %38
  %40 = getelementptr inbounds nuw i8, ptr %5, i64 24
  %41 = load double, ptr %40, align 8, !tbaa !55
  %42 = fmul double %34, %41
  %43 = tail call double @cos(double noundef %42) #6, !tbaa !49
  ...
  %51 = tail call double @sin(double noundef %50) #6, !tbaa !49
  %52 = fmul double %47, %51
  %53 = getelementptr inbounds nuw i8, ptr %5, i64 8
  %54 = load double, ptr %53, align 8, !tbaa !46
  %55 = load double, ptr %40, align 8, !tbaa !55
  %56 = fmul double %34, %55
  %57 = tail call double @sin(double noundef %56) #6, !tbaa !49
  %58 = fmul double %54, %57
  %59 = tail call double @cos(double noundef %45) #6, !tbaa !49
  %60 = fmul double %58, %59
  %61 = tail call double @cos(double noundef %50) #6, !tbaa !49
  %62 = fdiv double %60, %61
  %63 = insertvalue { double, double } poison, double %62, 0
  %64 = insertvalue { double, double } %63, double %52, 1
...
define internal { double, double } @_ZL13oea_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #0 {
  ...
  %23 = tail call double @cos(double noundef %22) #6, !tbaa !49
  %24 = fmul double %19, %23
  %25 = tail call double @cos(double noundef %13) #6, !tbaa !49
  %26 = fdiv double %24, %25
  %27 = tail call noundef double @_Z5aasinP6pj_ctxd(ptr noundef %16, double noundef %26)
  %28 = fmul double %15, %27
  %29 = tail call double @sin(double noundef %28) #6, !tbaa !49
  %30 = fmul double %29, 2.000000e+00
  %31 = tail call double @sin(double noundef %13) #6, !tbaa !49
  %32 = fmul double %31, 2.000000e+00
  %33 = getelementptr inbounds nuw i8, ptr %5, i64 24
  %34 = load double, ptr %33, align 8, !tbaa !55
  %35 = fmul double %28, %34
  %36 = tail call double @cos(double noundef %35) #6, !tbaa !49
  %37 = fmul double %32, %36
  %38 = tail call double @cos(double noundef %28) #6, !tbaa !49
  %39 = fdiv double %37, %38
  %40 = tail call noundef double @_Z6aatan2dd(double noundef %30, double noundef %39)
  %41 = load double, ptr %5, align 8, !tbaa !47
  %42 = fsub double %40, %41
  %43 = tail call double @cos(double noundef %42) #6, !tbaa !49
  %44 = load ptr, ptr %2, align 8, !tbaa !42
  %45 = tail call double @hypot(double noundef %30, double noundef %39) #6, !tbaa !49
  %46 = fmul double %45, 5.000000e-01
  %47 = tail call noundef double @_Z5aasinP6pj_ctxd(ptr noundef %44, double noundef %46)
  %48 = fmul double %47, 2.000000e+00
  %49 = tail call double @sin(double noundef %48) #6, !tbaa !49
  %50 = tail call double @cos(double noundef %48) #6, !tbaa !49
  ...
  %60 = tail call double @sin(double noundef %42) #6, !tbaa !49
  %61 = fmul double %49, %60
  %62 = load double, ptr %54, align 8, !tbaa !51
  %63 = load double, ptr %52, align 8, !tbaa !50
  ...
  %69 = insertvalue { double, double } poison, double %68, 0
  %70 = insertvalue { double, double } %69, double %59, 1
...
!43 = !{!5, !11, i64 24}
!44 = !{!45, !15, i64 16}
!45 = !{!"_ZTSN12_GLOBAL__N_16pj_oeaE", !15, i64 0, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !15, i64 40, !15, i64 48, !15, i64 56, !15, i64 64, !15, i64 72, !15, i64 80}
!46 = !{!45, !15, i64 8}
!47 = !{!45, !15, i64 0}
!48 = !{!5, !15, i64 448}
!49 = !{!14, !14, i64 0}
