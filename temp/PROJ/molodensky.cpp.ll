; ModuleID = '/home/mitch/Documents/PROJ/src/transformations/molodensky.cpp'
...
20:                                               ; preds = %17
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %3) #9, !noalias !57
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %3) #9, !noalias !57
  br label %33
...
18:                                               ; preds = %2
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %3) #9, !noalias !65
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %3) #9, !noalias !65
  br label %34

26:                                               ; preds = %2
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %5) #9, !noalias !65
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %5) #9, !noalias !65
  br label %34
...
39:                                               ; preds = %34
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %7) #9, !noalias !65
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %7) #9, !noalias !65
  br label %50
...
15:                                               ; preds = %3
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %4) #9, !noalias !69
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %4) #9, !noalias !69
  br label %17

16:                                               ; preds = %3
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %5) #9, !noalias !69
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %5) #9, !noalias !69
  br label %17
...
20:                                               ; preds = %17
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %6) #9, !noalias !69
  ...
  %24 = load double, ptr %23, align 8, !tbaa !60
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %6) #9, !noalias !69
  br label %29
...
14:                                               ; preds = %3
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %4) #9, !noalias !72
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %4) #9, !noalias !72
  br label %26

20:                                               ; preds = %3
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %6) #9, !noalias !72
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %6) #9, !noalias !72
  br label %26
...
30:                                               ; preds = %26
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %8) #9, !noalias !72
  ...
  %34 = load double, ptr %33, align 8, !tbaa !60
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %8) #9, !noalias !72
  br label %38
