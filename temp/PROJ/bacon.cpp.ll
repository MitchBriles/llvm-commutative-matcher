; ModuleID = '/home/mitch/Documents/PROJ/src/projections/bacon.cpp'
source_filename = "/home/mitch/Documents/PROJ/src/projections/bacon.cpp"
...
8:                                                ; preds = %3
  ...
  store ptr @_ZL15bacon_s_forward5PJ_LPP8PJconsts, ptr %11, align 8, !tbaa !40
  br label %21
...
15:                                               ; preds = %12
  ...
  store ptr @_ZL9des_bacon, ptr %17, align 8, !tbaa !42
...
6:                                                ; preds = %1
  ...
  store ptr @_ZL15bacon_s_forward5PJ_LPP8PJconsts, ptr %9, align 8, !tbaa !40
  br label %10
...
define internal { double, double } @_ZL15bacon_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #3 {
...
8:                                                ; preds = %3
  %9 = tail call double @sin(double noundef %1) #7, !tbaa !46
  %10 = fmul double %9, 0x3FF921FB54442D18
  br label %11

11:                                               ; preds = %3, %8
  %12 = phi double [ %10, %8 ], [ %1, %3 ]
  %13 = tail call double @llvm.fabs.f64(double %0)
  %14 = fcmp ult double %13, 1.000000e-10
...
15:                                               ; preds = %11
  ...
  %18 = icmp ne i32 %17, 0
  %19 = fcmp oge double %13, 0x3FF921FB54442D18
  %20 = and i1 %19, %18
  br i1 %20, label %21, label %28

21:                                               ; preds = %15
  %22 = fneg double %1
  %23 = tail call double @llvm.fmuladd.f64(double %22, double %1, double 0x4003BD3CC9BE45DE)
  %24 = fadd double %23, 1.000000e-10
  %25 = tail call double @sqrt(double noundef %24) #7, !tbaa !46
  %26 = fadd double %13, %25
  %27 = fadd double %26, 0xBFF921FB54442D18
  br label %38

28:                                               ; preds = %15
  %29 = fdiv double 0x4003BD3CC9BE45DE, %13
  %30 = fadd double %13, %29
  %31 = fmul double %30, 5.000000e-01
  %32 = fsub double %13, %31
  %33 = fneg double %12
...
43:                                               ; preds = %11, %38, %41
  %44 = phi double [ %42, %41 ], [ %39, %38 ], [ 0.000000e+00, %11 ]
  %45 = insertvalue { double, double } poison, double %44, 0
  %46 = insertvalue { double, double } %45, double %12, 1
...
15:                                               ; preds = %12
  ...
  %17 = getelementptr inbounds nuw i8, ptr %13, i64 16
  store ptr @_ZL9des_apian, ptr %17, align 8, !tbaa !42
  %18 = getelementptr inbounds nuw i8, ptr %13, i64 360
  store i32 1, ptr %18, align 8, !tbaa !43
  %19 = getelementptr inbounds nuw i8, ptr %13, i64 380
  store i32 4, ptr %19, align 4, !tbaa !44
...
8:                                                ; preds = %3
  ...
  store ptr @_ZL15bacon_s_forward5PJ_LPP8PJconsts, ptr %12, align 8, !tbaa !40
  br label %22
...
16:                                               ; preds = %13
  ...
  store ptr @.str.2, ptr %17, align 8, !tbaa !41
  %18 = getelementptr inbounds nuw i8, ptr %14, i64 16
  store ptr @_ZL9des_ortel, ptr %18, align 8, !tbaa !42
  ...
  store i32 4, ptr %20, align 4, !tbaa !44
...
6:                                                ; preds = %1
  ...
  store ptr @_ZL15bacon_s_forward5PJ_LPP8PJconsts, ptr %10, align 8, !tbaa !40
  br label %11
...
!37 = !{!38, !14, i64 0}
!38 = !{!"_ZTSN12_GLOBAL__N_18pj_baconE", !14, i64 0, !14, i64 4}
!39 = !{!5, !15, i64 216}
!40 = !{!5, !7, i64 104}
!41 = !{!5, !10, i64 8}
!42 = !{!5, !10, i64 16}
