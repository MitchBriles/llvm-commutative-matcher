; ModuleID = '/home/mitch/Documents/PROJ/src/projections/som.cpp'
...
define internal fastcc noundef ptr @_ZL9som_setupP8PJconsts(ptr noundef returned captures(ret: address, provenance) initializes((104, 120)) %0) unnamed_addr #4 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 88
  %3 = load ptr, ptr %2, align 8, !tbaa !41
  %4 = getelementptr inbounds nuw i8, ptr %3, i64 120
  %5 = load double, ptr %4, align 8, !tbaa !45
  %6 = tail call double @sin(double noundef %5) #9, !tbaa !49
  %7 = getelementptr inbounds nuw i8, ptr %3, i64 80
  store double %6, ptr %7, align 8, !tbaa !50
  %8 = tail call double @cos(double noundef %5) #9, !tbaa !49
  ...
  %55 = tail call double @sqrt(double noundef %54) #9, !tbaa !49
  %56 = fmul double %49, %55
  %57 = fdiv double %52, %51
  %58 = tail call double @sqrt(double noundef %57) #9, !tbaa !49
  ...
  %65 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %64)
  %66 = tail call double @llvm.sqrt.f64(double %65)
  %67 = fneg double %64
  %68 = tail call double @llvm.fmuladd.f64(double %63, double %37, double %67)
  %69 = fdiv double %68, %66
  %70 = fadd double %69, 0.000000e+00
  %71 = fadd double %37, %63
  %72 = fmul double %56, %71
  %73 = fdiv double %72, %66
  %74 = fadd double %73, 0.000000e+00
  %75 = fmul double %49, 0x3FEF9B24942FE45C
  %76 = tail call double @llvm.fmuladd.f64(double %30, double 0x3F990F1ECBBAB00A, double 1.000000e+00)
  %77 = tail call double @llvm.fmuladd.f64(double %24, double 0x3F990F1ECBBAB00A, double 1.000000e+00)
  %78 = tail call double @llvm.fmuladd.f64(double %25, double 0x3F990F1ECBBAB00A, double 1.000000e+00)
  %79 = fmul double %77, %78
  %80 = fdiv double %76, %79
  %81 = tail call double @sqrt(double noundef %80) #9, !tbaa !49
  %82 = fmul double %75, %81
  %83 = fdiv double %78, %77
  %84 = tail call double @sqrt(double noundef %83) #9, !tbaa !49
  %85 = fmul double %78, %78
  %86 = fdiv double %77, %85
  %87 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %86)
  %88 = fmul double %84, %87
  %89 = fmul double %82, %82
  %90 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %89)
  %91 = tail call double @llvm.sqrt.f64(double %90)
  %92 = fneg double %89
  %93 = tail call double @llvm.fmuladd.f64(double %88, double %37, double %92)
  %94 = fmul double %93, 4.000000e+00
  %95 = fdiv double %94, %91
  %96 = fadd double %70, %95
  %97 = tail call double @llvm.fmuladd.f64(double %95, double 0x3FEE6F0E134454FF, double %70)
  %98 = tail call double @llvm.fmuladd.f64(double %95, double 0x3FE9E3779B97F4A8, double %70)
  %99 = fmul double %82, 4.000000e+00
  %100 = fadd double %37, %88
  %101 = fmul double %99, %100
  %102 = fdiv double %101, %91
  %103 = tail call double @llvm.fmuladd.f64(double %102, double 0x3FEF9B24942FE45C, double %74)
  %104 = tail call double @llvm.fmuladd.f64(double %102, double 0x3FEC83201D3D2C6D, double %74)
  %105 = fmul double %49, 0x3FEC83201D3D2C6D
  %106 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FCA61B9F7154B43, double 1.000000e+00)
  %107 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FCA61B9F7154B43, double 1.000000e+00)
  %108 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FCA61B9F7154B43, double 1.000000e+00)
  %109 = fmul double %107, %108
  %110 = fdiv double %106, %109
  %111 = tail call double @sqrt(double noundef %110) #9, !tbaa !49
  %112 = fmul double %105, %111
  %113 = fdiv double %108, %107
  %114 = tail call double @sqrt(double noundef %113) #9, !tbaa !49
  %115 = fmul double %108, %108
  %116 = fdiv double %107, %115
  %117 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %116)
  %118 = fmul double %114, %117
  %119 = fmul double %112, %112
  %120 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %119)
  %121 = tail call double @llvm.sqrt.f64(double %120)
  %122 = fneg double %119
  %123 = tail call double @llvm.fmuladd.f64(double %118, double %37, double %122)
  %124 = fmul double %123, 4.000000e+00
  %125 = fdiv double %124, %121
  %126 = fadd double %96, %125
  %127 = tail call double @llvm.fmuladd.f64(double %125, double 0x3FE2CF2304755A5E, double %97)
  %128 = tail call double @llvm.fmuladd.f64(double %125, double 0xBFD3C6EF372FE94E, double %98)
  %129 = fmul double %112, 4.000000e+00
  %130 = fadd double %37, %118
  %131 = fmul double %129, %130
  %132 = fdiv double %131, %121
  %133 = tail call double @llvm.fmuladd.f64(double %132, double 0x3FEC83201D3D2C6D, double %103)
  %134 = tail call double @llvm.fmuladd.f64(double %132, double 0x3FC4060B67A85377, double %104)
  %135 = fmul double %49, 0x3FE6A09E667F3BCD
  %136 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FDFFFFFFFFFFFFE, double 1.000000e+00)
  %137 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FDFFFFFFFFFFFFE, double 1.000000e+00)
  %138 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FDFFFFFFFFFFFFE, double 1.000000e+00)
  %139 = fmul double %137, %138
  %140 = fdiv double %136, %139
  %141 = tail call double @sqrt(double noundef %140) #9, !tbaa !49
  %142 = fmul double %135, %141
  %143 = fdiv double %138, %137
  %144 = tail call double @sqrt(double noundef %143) #9, !tbaa !49
  %145 = fmul double %138, %138
  %146 = fdiv double %137, %145
  %147 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %146)
  %148 = fmul double %144, %147
  %149 = fmul double %142, %142
  %150 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %149)
  %151 = tail call double @llvm.sqrt.f64(double %150)
  %152 = fneg double %149
  %153 = tail call double @llvm.fmuladd.f64(double %148, double %37, double %152)
  %154 = fmul double %153, 4.000000e+00
  %155 = fdiv double %154, %151
  %156 = fadd double %126, %155
  %157 = tail call double @llvm.fmuladd.f64(double %155, double 0x3C91A62633145C07, double %127)
  %158 = fsub double %128, %155
  %159 = fmul double %142, 4.000000e+00
  %160 = fadd double %37, %148
  %161 = fmul double %159, %160
  %162 = fdiv double %161, %151
  %163 = tail call double @llvm.fmuladd.f64(double %162, double 0x3FE6A09E667F3BCD, double %133)
  %164 = tail call double @llvm.fmuladd.f64(double %162, double 0xBFE6A09E667F3BCC, double %134)
  %165 = fmul double %49, 0x3FDD0E2E2B44DE01
  %166 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FE96791823AAD2E, double 1.000000e+00)
  %167 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FE96791823AAD2E, double 1.000000e+00)
  %168 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FE96791823AAD2E, double 1.000000e+00)
  %169 = fmul double %167, %168
  %170 = fdiv double %166, %169
  %171 = tail call double @sqrt(double noundef %170) #9, !tbaa !49
  %172 = fmul double %165, %171
  %173 = fdiv double %168, %167
  %174 = tail call double @sqrt(double noundef %173) #9, !tbaa !49
  %175 = fmul double %168, %168
  %176 = fdiv double %167, %175
  %177 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %176)
  %178 = fmul double %174, %177
  %179 = fmul double %172, %172
  %180 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %179)
  %181 = tail call double @llvm.sqrt.f64(double %180)
  %182 = fneg double %179
  %183 = tail call double @llvm.fmuladd.f64(double %178, double %37, double %182)
  %184 = fmul double %183, 4.000000e+00
  %185 = fdiv double %184, %181
  %186 = fadd double %156, %185
  %187 = tail call double @llvm.fmuladd.f64(double %185, double 0xBFE2CF2304755A5D, double %157)
  %188 = tail call double @llvm.fmuladd.f64(double %185, double 0xBFD3C6EF372FE952, double %158)
  %189 = fmul double %172, 4.000000e+00
  %190 = fadd double %37, %178
  %191 = fmul double %189, %190
  %192 = fdiv double %191, %181
  %193 = tail call double @llvm.fmuladd.f64(double %192, double 0x3FDD0E2E2B44DE01, double %163)
  %194 = tail call double @llvm.fmuladd.f64(double %192, double 0xBFEF9B24942FE45C, double %164)
  %195 = fmul double %49, 0x3FC4060B67A85377
  %196 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FEF378709A22A80, double 1.000000e+00)
  %197 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FEF378709A22A80, double 1.000000e+00)
  %198 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FEF378709A22A80, double 1.000000e+00)
  %199 = fmul double %197, %198
  %200 = fdiv double %196, %199
  %201 = tail call double @sqrt(double noundef %200) #9, !tbaa !49
  %202 = fmul double %195, %201
  %203 = fdiv double %198, %197
  %204 = tail call double @sqrt(double noundef %203) #9, !tbaa !49
  %205 = fmul double %198, %198
  %206 = fdiv double %197, %205
  %207 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %206)
  %208 = fmul double %204, %207
  %209 = fmul double %202, %202
  %210 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %209)
  %211 = tail call double @llvm.sqrt.f64(double %210)
  %212 = fneg double %209
  %213 = tail call double @llvm.fmuladd.f64(double %208, double %37, double %212)
  %214 = fmul double %213, 4.000000e+00
  %215 = fdiv double %214, %211
  %216 = fadd double %186, %215
  %217 = tail call double @llvm.fmuladd.f64(double %215, double 0xBFEE6F0E134454FF, double %187)
  %218 = tail call double @llvm.fmuladd.f64(double %215, double 0x3FE9E3779B97F4A7, double %188)
  %219 = fmul double %202, 4.000000e+00
  %220 = fadd double %37, %208
  %221 = fmul double %219, %220
  %222 = fdiv double %221, %211
  %223 = tail call double @llvm.fmuladd.f64(double %222, double 0x3FC4060B67A85377, double %193)
  %224 = tail call double @llvm.fmuladd.f64(double %222, double 0xBFDD0E2E2B44DE03, double %194)
  %225 = fmul double %49, 0x3FEE6F0E134454FF
  %226 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FB8722191A02D60, double 1.000000e+00)
  %227 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FB8722191A02D60, double 1.000000e+00)
  %228 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FB8722191A02D60, double 1.000000e+00)
  %229 = fmul double %227, %228
  %230 = fdiv double %226, %229
  %231 = tail call double @sqrt(double noundef %230) #9, !tbaa !49
  %232 = fmul double %225, %231
  %233 = fdiv double %228, %227
  %234 = tail call double @sqrt(double noundef %233) #9, !tbaa !49
  %235 = fmul double %228, %228
  %236 = fdiv double %227, %235
  %237 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %236)
  %238 = fmul double %234, %237
  %239 = fmul double %232, %232
  %240 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %239)
  %241 = tail call double @llvm.sqrt.f64(double %240)
  %242 = fneg double %239
  %243 = tail call double @llvm.fmuladd.f64(double %238, double %37, double %242)
  %244 = fmul double %243, 2.000000e+00
  %245 = fdiv double %244, %241
  %246 = fadd double %216, %245
  %247 = tail call double @llvm.fmuladd.f64(double %245, double 0x3FE9E3779B97F4A8, double %217)
  %248 = tail call double @llvm.fmuladd.f64(double %245, double 0x3FD3C6EF372FE950, double %218)
  %249 = fmul double %232, 2.000000e+00
  %250 = fadd double %37, %238
  %251 = fmul double %249, %250
  %252 = fdiv double %251, %241
  %253 = tail call double @llvm.fmuladd.f64(double %252, double 0x3FEE6F0E134454FF, double %223)
  %254 = tail call double @llvm.fmuladd.f64(double %252, double 0x3FE2CF2304755A5E, double %224)
  %255 = fmul double %49, 0x3FE9E3779B97F4A8
  %256 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FD61C8864680B58, double 1.000000e+00)
  %257 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FD61C8864680B58, double 1.000000e+00)
  %258 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FD61C8864680B58, double 1.000000e+00)
  %259 = fmul double %257, %258
  %260 = fdiv double %256, %259
  %261 = tail call double @sqrt(double noundef %260) #9, !tbaa !49
  %262 = fmul double %255, %261
  %263 = fdiv double %258, %257
  %264 = tail call double @sqrt(double noundef %263) #9, !tbaa !49
  %265 = fmul double %258, %258
  %266 = fdiv double %257, %265
  %267 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %266)
  %268 = fmul double %264, %267
  %269 = fmul double %262, %262
  %270 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %269)
  %271 = tail call double @llvm.sqrt.f64(double %270)
  %272 = fneg double %269
  %273 = tail call double @llvm.fmuladd.f64(double %268, double %37, double %272)
  %274 = fmul double %273, 2.000000e+00
  %275 = fdiv double %274, %271
  %276 = fadd double %246, %275
  %277 = tail call double @llvm.fmuladd.f64(double %275, double 0x3FD3C6EF372FE950, double %247)
  %278 = tail call double @llvm.fmuladd.f64(double %275, double 0xBFE9E3779B97F4A7, double %248)
  %279 = fmul double %262, 2.000000e+00
  %280 = fadd double %37, %268
  %281 = fmul double %279, %280
  %282 = fdiv double %281, %271
  %283 = tail call double @llvm.fmuladd.f64(double %282, double 0x3FE9E3779B97F4A8, double %253)
  %284 = tail call double @llvm.fmuladd.f64(double %282, double 0xBFD3C6EF372FE94E, double %254)
  %285 = fmul double %49, 0x3FE2CF2304755A5E
  %286 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FE4F1BBCDCBFA54, double 1.000000e+00)
  %287 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FE4F1BBCDCBFA54, double 1.000000e+00)
  %288 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FE4F1BBCDCBFA54, double 1.000000e+00)
  %289 = fmul double %287, %288
  %290 = fdiv double %286, %289
  %291 = tail call double @sqrt(double noundef %290) #9, !tbaa !49
  %292 = fmul double %285, %291
  %293 = fdiv double %288, %287
  %294 = tail call double @sqrt(double noundef %293) #9, !tbaa !49
  %295 = fmul double %288, %288
  %296 = fdiv double %287, %295
  %297 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %296)
  %298 = fmul double %294, %297
  %299 = fmul double %292, %292
  %300 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %299)
  %301 = tail call double @llvm.sqrt.f64(double %300)
  %302 = fneg double %299
  %303 = tail call double @llvm.fmuladd.f64(double %298, double %37, double %302)
  %304 = fmul double %303, 2.000000e+00
  %305 = fdiv double %304, %301
  %306 = fadd double %276, %305
  %307 = tail call double @llvm.fmuladd.f64(double %305, double 0xBFD3C6EF372FE94E, double %277)
  %308 = tail call double @llvm.fmuladd.f64(double %305, double 0xBFE9E3779B97F4A9, double %278)
  %309 = fmul double %292, 2.000000e+00
  %310 = fadd double %37, %298
  %311 = fmul double %309, %310
  %312 = fdiv double %311, %301
  %313 = tail call double @llvm.fmuladd.f64(double %312, double 0x3FE2CF2304755A5E, double %283)
  %314 = tail call double @llvm.fmuladd.f64(double %312, double 0xBFEE6F0E134454FF, double %284)
  %315 = fmul double %49, 0x3FD3C6EF372FE950
  %316 = tail call double @llvm.fmuladd.f64(double %30, double 0x3FECF1BBCDCBFA53, double 1.000000e+00)
  %317 = tail call double @llvm.fmuladd.f64(double %24, double 0x3FECF1BBCDCBFA53, double 1.000000e+00)
  %318 = tail call double @llvm.fmuladd.f64(double %25, double 0x3FECF1BBCDCBFA53, double 1.000000e+00)
  %319 = fmul double %317, %318
  %320 = fdiv double %316, %319
  %321 = tail call double @sqrt(double noundef %320) #9, !tbaa !49
  %322 = fmul double %315, %321
  %323 = fdiv double %318, %317
  %324 = tail call double @sqrt(double noundef %323) #9, !tbaa !49
  %325 = fmul double %318, %318
  %326 = fdiv double %317, %325
  %327 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %326)
  %328 = fmul double %324, %327
  %329 = fmul double %322, %322
  %330 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %329)
  %331 = tail call double @llvm.sqrt.f64(double %330)
  %332 = fneg double %329
  %333 = tail call double @llvm.fmuladd.f64(double %328, double %37, double %332)
  %334 = fmul double %333, 2.000000e+00
  %335 = fdiv double %334, %331
  %336 = fadd double %306, %335
  %337 = tail call double @llvm.fmuladd.f64(double %335, double 0xBFE9E3779B97F4A7, double %307)
  %338 = tail call double @llvm.fmuladd.f64(double %335, double 0x3FD3C6EF372FE94C, double %308)
  %339 = fmul double %322, 2.000000e+00
  %340 = fadd double %37, %328
  %341 = fmul double %339, %340
  %342 = fdiv double %341, %331
  %343 = tail call double @llvm.fmuladd.f64(double %342, double 0x3FD3C6EF372FE950, double %313)
  %344 = tail call double @llvm.fmuladd.f64(double %342, double 0xBFE9E3779B97F4A9, double %314)
  %345 = fmul double %49, 0x3C91A62633145C07
  %346 = fadd double %30, 1.000000e+00
  %347 = fadd double %24, 1.000000e+00
  %348 = fadd double %25, 1.000000e+00
  %349 = fmul double %348, %347
  %350 = fdiv double %346, %349
  %351 = tail call double @sqrt(double noundef %350) #9, !tbaa !49
  %352 = fmul double %345, %351
  %353 = fdiv double %348, %347
  %354 = tail call double @sqrt(double noundef %353) #9, !tbaa !49
  %355 = fmul double %348, %348
  %356 = fdiv double %347, %355
  %357 = tail call double @llvm.fmuladd.f64(double %61, double %12, double %356)
  %358 = fmul double %357, %354
  %359 = fmul double %352, %352
  %360 = tail call double @llvm.fmuladd.f64(double %37, double %37, double %359)
  %361 = tail call double @llvm.sqrt.f64(double %360)
  %362 = fneg double %359
  %363 = tail call double @llvm.fmuladd.f64(double %358, double %37, double %362)
  %364 = fdiv double %363, %361
  %365 = fadd double %336, %364
  %366 = fsub double %337, %364
  %367 = fadd double %364, %338
  %368 = fadd double %37, %358
  %369 = fmul double %352, %368
  %370 = fdiv double %369, %361
  %371 = tail call double @llvm.fmuladd.f64(double %370, double 0x3C91A62633145C07, double %343)
  %372 = tail call double @llvm.fmuladd.f64(double %370, double 0xBCAA79394C9E8A0A, double %344)
  %373 = fdiv double %366, 3.000000e+01
  store double %373, ptr %3, align 8, !tbaa !61
  %374 = fdiv double %367, 6.000000e+01
  store double %374, ptr %46, align 8, !tbaa !62
  %375 = fdiv double %365, 3.000000e+01
  store double %375, ptr %45, align 8, !tbaa !63
  %376 = fdiv double %371, 1.500000e+01
  store double %376, ptr %44, align 8, !tbaa !64
  %377 = fdiv double %372, 4.500000e+01
  store double %377, ptr %43, align 8, !tbaa !65
  %378 = getelementptr inbounds nuw i8, ptr %0, i64 112
  store ptr @_ZL13som_e_inverse5PJ_XYP8PJconsts, ptr %378, align 8, !tbaa !66
  %379 = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr @_ZL13som_e_forward5PJ_LPP8PJconsts, ptr %379, align 8, !tbaa !67
  ret ptr %0
}
...
32:                                               ; preds = %32, %3
  ...
  %35 = tail call double @sin(double noundef %33) #9, !tbaa !49
  %36 = fmul double %35, %35
  %37 = tail call double @cos(double noundef %33) #9, !tbaa !49
...
70:                                               ; preds = %32
  ...
  %93 = tail call double @sin(double noundef %87) #9, !tbaa !49
...
106:                                              ; preds = %70
  ...
  %111 = tail call double @tan(double noundef %92) #9, !tbaa !49
  ...
  %121 = tail call double @sqrt(double noundef %120) #9, !tbaa !49
  %122 = tail call double @cos(double noundef %92) #9, !tbaa !49
  %123 = fneg double %121
  ...
  %128 = tail call double @atan(double noundef %127) #9, !tbaa !49
  %129 = fcmp oge double %128, 0.000000e+00
  %130 = select i1 %129, double 1.000000e+00, double -1.000000e+00
  %131 = tail call double @cos(double noundef %92) #9, !tbaa !49
...
139:                                              ; preds = %106
  ...
  %147 = tail call double @sqrt(double noundef %146) #9, !tbaa !49
  %148 = fdiv double %93, %147
  %149 = tail call noundef double @_Z5aasinP6pj_ctxd(ptr noundef %140, double noundef %148)
  br label %162

150:                                              ; preds = %106
  %151 = tail call double @tan(double noundef %92) #9, !tbaa !49
  %152 = tail call double @cos(double noundef %134) #9, !tbaa !49
  %153 = tail call double @sin(double noundef %134) #9, !tbaa !49
  %154 = fneg double %153
  ...
  %161 = tail call double @atan(double noundef %160) #9, !tbaa !49
  br label %162

162:                                              ; preds = %139, %150, %101
...
10:                                               ; preds = %3, %7, %9
  ...
  %14 = tail call double @tan(double noundef %11) #9, !tbaa !49
  ...
  %27 = tail call double @cos(double noundef %26) #9, !tbaa !49
  %28 = fcmp olt double %27, 0.000000e+00
  %29 = tail call double @sin(double noundef %13) #9, !tbaa !49
  %30 = fneg double %29
...
33:                                               ; preds = %10, %53
  ...
  %37 = tail call double @cos(double noundef %36) #9, !tbaa !49
...
70:                                               ; preds = %69, %66, %64
  ...
  %73 = tail call double @cos(double noundef %72) #9, !tbaa !49
  %74 = fcmp olt double %73, 0.000000e+00
  %75 = tail call double @sin(double noundef %71) #9, !tbaa !49
  %76 = fneg double %75
...
79:                                               ; preds = %99, %70
  ...
  %83 = tail call double @cos(double noundef %82) #9, !tbaa !49
...
115:                                              ; preds = %114, %111, %109
  ...
  %118 = tail call double @cos(double noundef %117) #9, !tbaa !49
  %119 = fcmp olt double %118, 0.000000e+00
  %120 = tail call double @sin(double noundef %116) #9, !tbaa !49
  %121 = fneg double %120
...
124:                                              ; preds = %144, %115
  ...
  %128 = tail call double @cos(double noundef %127) #9, !tbaa !49
...
149:                                              ; preds = %144, %147, %106, %61
  %150 = phi double [ %41, %61 ], [ %87, %106 ], [ %132, %147 ], [ %132, %144 ]
  %151 = phi double [ %47, %61 ], [ %93, %106 ], [ %138, %147 ], [ %138, %144 ]
  %152 = tail call double @sin(double noundef %11) #9, !tbaa !49
  %153 = load ptr, ptr %2, align 8, !tbaa !42
  %154 = fmul double %18, %23
  %155 = tail call double @cos(double noundef %11) #9, !tbaa !49
  %156 = fmul double %21, %155
  %157 = tail call double @sin(double noundef %150) #9, !tbaa !49
  %158 = fneg double %157
  ...
  %166 = tail call double @sqrt(double noundef %165) #9, !tbaa !49
  ...
  %170 = tail call double @tan(double noundef %169) #9, !tbaa !49
  %171 = tail call double @log(double noundef %170) #9, !tbaa !49
  %172 = tail call double @sin(double noundef %151) #9, !tbaa !49
  %173 = fmul double %172, %172
  %174 = load double, ptr %15, align 8, !tbaa !47
  %175 = load double, ptr %20, align 8, !tbaa !50
  %176 = fmul double %174, %175
  %177 = tail call double @cos(double noundef %151) #9, !tbaa !49
  ...
  %190 = tail call double @sqrt(double noundef %189) #9, !tbaa !49
  ...
  %195 = tail call double @llvm.fmuladd.f64(double %193, double %193, double %194)
  %196 = tail call double @llvm.sqrt.f64(double %195)
  %197 = getelementptr inbounds nuw i8, ptr %5, i64 16
  %198 = load double, ptr %197, align 8, !tbaa !63
  %199 = load double, ptr %5, align 8, !tbaa !61
  %200 = fmul double %151, 2.000000e+00
  %201 = tail call double @sin(double noundef %200) #9, !tbaa !49
  %202 = fmul double %199, %201
  %203 = tail call double @llvm.fmuladd.f64(double %198, double %151, double %202)
  %204 = getelementptr inbounds nuw i8, ptr %5, i64 8
  %205 = load double, ptr %204, align 8, !tbaa !62
  %206 = fmul double %151, 4.000000e+00
  %207 = tail call double @sin(double noundef %206) #9, !tbaa !49
  %208 = tail call double @llvm.fmuladd.f64(double %205, double %207, double %203)
  %209 = fmul double %171, %191
  ...
  %216 = fmul double %151, 3.000000e+00
  %217 = tail call double @sin(double noundef %216) #9, !tbaa !49
  %218 = fmul double %215, %217
  %219 = tail call double @llvm.fmuladd.f64(double %213, double %172, double %218)
  %220 = fmul double %171, %193
  %221 = fdiv double %220, %196
  %222 = fadd double %221, %219
  br label %223

223:                                              ; preds = %56, %102, %147, %149
  %224 = phi double [ %222, %149 ], [ 0x7FF0000000000000, %147 ], [ 0x7FF0000000000000, %102 ], [ 0x7FF0000000000000, %56 ]
  %225 = phi double [ %211, %149 ], [ 0x7FF0000000000000, %147 ], [ 0x7FF0000000000000, %102 ], [ 0x7FF0000000000000, %56 ]
  %226 = insertvalue { double, double } poison, double %225, 0
  %227 = insertvalue { double, double } %226, double %224, 1
  ret { double, double } %227
}
...
attributes #4 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
