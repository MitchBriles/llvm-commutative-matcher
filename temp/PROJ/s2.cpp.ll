; ModuleID = '/home/mitch/Documents/PROJ/src/projections/s2.cpp'
...
define linkonce_odr hidden void @_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE16S2ProjectionTypeSt4lessIS5_ESaISt4pairIKS5_S6_EEED2Ev(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #1 comdat align 2 personality ptr @__gxx_personality_v0 {
...
define hidden noundef ptr @pj_s2(ptr noundef %0) local_unnamed_addr #3 {
...
; Function Attrs: mustprogress sspstrong uwtable
define hidden noundef ptr @_Z31pj_projection_specific_setup_s2P8PJconsts(ptr noundef %0) local_unnamed_addr #3 personality ptr @__gxx_personality_v0 {
  %2 = alloca i64, align 8
  %3 = alloca %"class.std::__cxx11::basic_string", align 8
  %4 = tail call noalias dereferenceable_or_null(40) ptr @calloc(i64 noundef 1, i64 noundef 40) #23
...
16:                                               ; preds = %8
  ...
  %18 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %15) #24
...
59:                                               ; preds = %56, %53, %47
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %3) #24
  %62 = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTISt12out_of_range) #24
...
20:                                               ; preds = %12
  ...
  %23 = tail call i32 @memcmp(ptr noundef %22, ptr noundef %11, i64 noundef %18) #24
  %24 = icmp eq i32 %23, 0
...
46:                                               ; preds = %40
  ...
  %49 = tail call i32 @memcmp(ptr noundef %11, ptr noundef %48, i64 noundef %44) #24
  %50 = icmp eq i32 %49, 0
...
59:                                               ; preds = %2, %38, %56
  tail call void @_ZSt20__throw_out_of_rangePKc(ptr noundef nonnull @.str.8) #26
  unreachable
...
define internal { double, double } @_ZL10s2_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #9 {
...
22:                                               ; preds = %3
  ...
  %24 = tail call double @tan(double noundef %23) #24, !tbaa !73
  ...
  %27 = tail call double @tan(double noundef %26) #24, !tbaa !73
...
66:                                               ; preds = %42, %52, %54, %57, %61, %64
  ...
  %70 = fneg double %69
  %71 = tail call double @acos(double noundef %70) #24, !tbaa !73
  %72 = fadd double %71, 0xBFF921FB54442D18
  %73 = tail call double @atan2(double noundef %67, double noundef %68) #24, !tbaa !73
...
77:                                               ; preds = %66
  ...
  %79 = tail call double @tan(double noundef %72) #24, !tbaa !73
  ...
  %87 = tail call double @sqrt(double noundef %86) #24, !tbaa !73
...
; Function Attrs: mustprogress nofree norecurse nounwind sspstrong memory(read, inaccessiblemem: readwrite, errnomem: readwrite) uwtable
define internal { double, double } @_ZL10s2_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #9 {
  %4 = alloca double, align 8
  %5 = alloca double, align 8
  %6 = getelementptr inbounds nuw i8, ptr %2, i64 88
  %7 = load ptr, ptr %6, align 8, !tbaa !46
...
11:                                               ; preds = %3
  ...
  %14 = tail call double @tan(double noundef %1) #24, !tbaa !73
  %15 = fmul double %13, %14
  %16 = tail call double @atan(double noundef %15) #24, !tbaa !73
  br label %17

17:                                               ; preds = %3, %11
  %18 = phi double [ %16, %11 ], [ %1, %3 ]
  %19 = tail call double @sin(double noundef %18) #24, !tbaa !73
  %20 = tail call double @cos(double noundef %18) #24, !tbaa !73
  %21 = tail call double @sin(double noundef %0) #24, !tbaa !73
  %22 = tail call double @cos(double noundef %0) #24, !tbaa !73
...
70:                                               ; preds = %50
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %5)
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %4)
  %75 = tail call double @atan(double noundef %52) #24, !tbaa !73
...
; Function Attrs: mustprogress nounwind sspstrong uwtable
define linkonce_odr hidden void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_16S2ProjectionTypeESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EED2Ev(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #1 comdat align 2 personality ptr @__gxx_personality_v0 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 16
  %3 = load ptr, ptr %2, align 8, !tbaa !4
  invoke void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_16S2ProjectionTypeESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EE8_M_eraseEPSt13_Rb_tree_nodeIS9_E(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr noundef %3)
...
23:                                               ; preds = %14
  ...
  %27 = tail call i32 @memcmp(ptr noundef %26, ptr noundef %25, i64 noundef %21) #24
  %28 = icmp eq i32 %27, 0
...
37:                                               ; preds = %9, %34
  ...
  %40 = tail call noalias noundef nonnull dereferenceable(72) ptr @_Znwm(i64 noundef 72) #27
  ...
  tail call void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 noundef zeroext %38, ptr noundef nonnull %40, ptr noundef nonnull %7, ptr noundef nonnull align 8 dereferenceable(32) %11) #24
...
define internal void @_GLOBAL__sub_I_s2.cpp() #19 section ".text.startup" personality ptr @__gxx_personality_v0 {
...
32:                                               ; preds = %27, %25, %23, %0
  %33 = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_16S2ProjectionTypeESt10_Select1stIS9_ESt4lessIS5_ESaIS9_EED2Ev(ptr noundef nonnull align 8 dereferenceable(48) @_ZL24stringToS2ProjectionTypeB5cxx11) #24
...
39:                                               ; preds = %29
  ...
  %41 = add i64 %40, 1
  call void @_ZdlPvm(ptr noundef %30, i64 noundef %41) #25
  br label %42
...
72:                                               ; preds = %32
  ...
  %74 = add i64 %73, 1
  call void @_ZdlPvm(ptr noundef %34, i64 noundef %74) #25
  br label %75
...
102:                                              ; preds = %99, %96
  call void @llvm.lifetime.end.p0(i64 160, ptr nonnull %2) #24
  resume { ptr, i32 } %33

103:                                              ; preds = %63, %66
  call void @llvm.lifetime.end.p0(i64 160, ptr nonnull %2) #24
  %104 = call i32 @__cxa_atexit(ptr nonnull @_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE16S2ProjectionTypeSt4lessIS5_ESaISt4pairIKS5_S6_EEED2Ev, ptr nonnull @_ZL24stringToS2ProjectionTypeB5cxx11, ptr nonnull @__dso_handle) #24
  ret void
}
...
attributes #9 = { mustprogress nofree norecurse nounwind sspstrong memory(read, inaccessiblemem: readwrite, errnomem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
