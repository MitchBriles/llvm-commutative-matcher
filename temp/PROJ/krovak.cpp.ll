; ModuleID = '/home/mitch/Documents/PROJ/src/projections/krovak.cpp'
...
52:                                               ; preds = %51, %43
  ...
  %56 = tail call double @cos(double noundef %55) #8, !tbaa !53
  %57 = tail call noundef double @pow(double noundef %56, double noundef 4.000000e+00) #8, !tbaa !53
  %58 = fmul double %53, %57
  %59 = fsub double 1.000000e+00, %53
  %60 = fdiv double %58, %59
  %61 = fadd double %60, 1.000000e+00
  %62 = tail call double @sqrt(double noundef %61) #8, !tbaa !53
  store double %62, ptr %4, align 8, !tbaa !54
  %63 = tail call double @sin(double noundef %55) #8, !tbaa !53
  %64 = fdiv double %63, %62
  %65 = tail call double @asin(double noundef %64) #8, !tbaa !53
  %66 = load double, ptr %12, align 8, !tbaa !44
  %67 = tail call double @sin(double noundef %55) #8, !tbaa !53
  ...
  %74 = tail call double @pow(double noundef %71, double noundef %73) #8, !tbaa !53
  %75 = fmul double %55, 5.000000e-01
  %76 = fadd double %75, 0x3FE921FB54442D18
  %77 = tail call double @tan(double noundef %76) #8, !tbaa !53
...
81:                                               ; preds = %52
  ...
  %84 = tail call double @tan(double noundef %83) #8, !tbaa !53
  %85 = tail call double @pow(double noundef %77, double noundef %62) #8, !tbaa !53
  %86 = fdiv double %84, %85
  %87 = fmul double %74, %86
  %88 = getelementptr inbounds nuw i8, ptr %4, i64 8
  store double %87, ptr %88, align 8, !tbaa !55
  %89 = tail call double @sqrt(double noundef %59) #8, !tbaa !53
  %90 = tail call double @sin(double noundef %55) #8, !tbaa !53
...
77:                                               ; preds = %30, %24
  ...
  %82 = tail call double @atan2(double noundef %79, double noundef %78) #8, !tbaa !53
  %83 = fdiv double %82, 0x3FEF5B8B0DDC7212
  %84 = fcmp oeq double %81, 0.000000e+00
  br i1 %84, label %98, label %85

85:                                               ; preds = %77
  %86 = tail call double @llvm.sqrt.f64(double %81)
  ...
  %93 = tail call double @pow(double noundef %89, double noundef %92) #8, !tbaa !53
  %94 = fmul double %93, 0x4023DCAD2E5FE87A
  %95 = tail call double @atan(double noundef %94) #8, !tbaa !53
...
98:                                               ; preds = %77, %85
  ...
  %102 = tail call double @cos(double noundef %101) #8, !tbaa !53
  %103 = tail call double @sin(double noundef %99) #8, !tbaa !53
  %104 = tail call double @sin(double noundef %101) #8, !tbaa !53
  %105 = tail call double @cos(double noundef %99) #8, !tbaa !53
  %106 = fmul double %104, %105
  %107 = tail call double @cos(double noundef %83) #8, !tbaa !53
  %108 = fneg double %107
  %109 = fmul double %106, %108
  %110 = tail call double @llvm.fmuladd.f64(double %102, double %103, double %109)
  %111 = tail call double @asin(double noundef %110) #8, !tbaa !53
  %112 = tail call double @cos(double noundef %99) #8, !tbaa !53
  %113 = tail call double @sin(double noundef %83) #8, !tbaa !53
  %114 = fmul double %112, %113
  %115 = tail call double @cos(double noundef %111) #8, !tbaa !53
  %116 = fdiv double %114, %115
  %117 = tail call double @asin(double noundef %116) #8, !tbaa !53
...
134:                                              ; preds = %98, %131
  ...
  %137 = tail call double @pow(double noundef %122, double noundef %123) #8, !tbaa !53
  %138 = tail call double @tan(double noundef %125) #8, !tbaa !53
  %139 = tail call double @pow(double noundef %138, double noundef %126) #8, !tbaa !53
  %140 = fmul double %137, %139
  %141 = tail call double @sin(double noundef %136) #8, !tbaa !53
  ...
  %145 = tail call double @pow(double noundef %144, double noundef %130) #8, !tbaa !53
  %146 = fmul double %140, %145
  %147 = tail call double @atan(double noundef %146) #8, !tbaa !53
...
define internal { double, double } @_ZL16krovak_e_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #5 {
  ...
  %8 = tail call double @sin(double noundef %1) #8, !tbaa !53
  ...
  %16 = tail call double @pow(double noundef %12, double noundef %15) #8, !tbaa !53
  ...
  %22 = tail call double @pow(double noundef %21, double noundef %13) #8, !tbaa !53
  ...
  %32 = tail call double @cos(double noundef %31) #8, !tbaa !53
  %33 = tail call double @sin(double noundef %27) #8, !tbaa !53
  %34 = tail call double @sin(double noundef %31) #8, !tbaa !53
  %35 = tail call double @cos(double noundef %27) #8, !tbaa !53
  %36 = fmul double %34, %35
  %37 = tail call double @cos(double noundef %29) #8, !tbaa !53
  %38 = fmul double %36, %37
  %39 = tail call double @llvm.fmuladd.f64(double %32, double %33, double %38)
  %40 = tail call double @asin(double noundef %39) #8, !tbaa !53
  %41 = tail call double @cos(double noundef %40) #8, !tbaa !53
  %42 = fcmp olt double %41, 0x3D719799812DEA11
  br i1 %42, label %136, label %43

43:                                               ; preds = %3
  %44 = tail call double @cos(double noundef %27) #8, !tbaa !53
  %45 = tail call double @sin(double noundef %29) #8, !tbaa !53
  %46 = fmul double %44, %45
  %47 = fdiv double %46, %41
  %48 = tail call double @asin(double noundef %47) #8, !tbaa !53
  %49 = getelementptr inbounds nuw i8, ptr %5, i64 16
  %50 = load double, ptr %49, align 8, !tbaa !56
  %51 = fmul double %48, %50
  %52 = getelementptr inbounds nuw i8, ptr %5, i64 24
  %53 = load double, ptr %52, align 8, !tbaa !57
  %54 = tail call double @pow(double noundef 0x4023DCAD2E5FE87A, double noundef %50) #8, !tbaa !53
  %55 = fmul double %53, %54
  %56 = fmul double %40, 5.000000e-01
  %57 = fadd double %56, 0x3FE921FB54442D18
  %58 = tail call double @tan(double noundef %57) #8, !tbaa !53
  %59 = tail call double @pow(double noundef %58, double noundef %50) #8, !tbaa !53
  %60 = fdiv double %55, %59
  %61 = tail call double @cos(double noundef %51) #8, !tbaa !53
  %62 = fmul double %60, %61
  %63 = tail call double @sin(double noundef %51) #8, !tbaa !53
