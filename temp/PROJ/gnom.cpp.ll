; ModuleID = '/home/mitch/Documents/PROJ/src/projections/gnom.cpp'
...
define internal { double, double } @_ZL14gnom_s_inverse5PJ_XYP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #6 {
...
151:                                              ; preds = %152, %161, %172, %183, %194, %205, %216, %227, %238, %34, %44, %56, %68, %80, %92, %104, %116, %128
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %9) #9
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %8) #9
  br label %259
