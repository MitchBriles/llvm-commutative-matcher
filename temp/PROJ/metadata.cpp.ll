; ModuleID = '/home/mitch/Documents/PROJ/src/iso19111/metadata.cpp'
...
57:                                               ; preds = %2, %34, %44, %53, %8, %36, %43, %49, %51, %5
...
88:                                               ; preds = %83
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %7) #39
...
140:                                              ; preds = %73, %82, %127, %125, %87, %54, %39, %32
  ret void
}
...
define hidden noundef zeroext i1 @_ZNK5osgeo4proj8metadata14TemporalExtent15_isEquivalentToEPKNS0_4util11IComparableENS4_9CriterionERKSt10shared_ptrINS0_2io15DatabaseContextEE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %0, ptr noundef readonly %1, i32 %2, ptr nonnull readnone align 8 captures(none) %3) unnamed_addr #18 align 2 personality ptr @__gxx_personality_v0 {
  %5 = icmp eq ptr %1, null
...
181:                                              ; preds = %107, %136, %165, %152, %17, %4, %6, %9, %29, %34, %54, %74
...
160:                                              ; preds = %157, %133, %59, %27, %95, %85, %77
...
160:                                              ; preds = %157, %134, %59, %27, %95, %85, %78
...
103:                                              ; preds = %100
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %8) #39
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %9) #39
...
139:                                              ; preds = %137, %134, %122
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %11) #39
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %11, i8 0, i64 24, i1 false)
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %12) #39
...
194:                                              ; preds = %185, %188
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %12) #39
...
316:                                              ; preds = %288, %297, %312, %315
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %10) #39
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %9) #39
...
325:                                              ; preds = %319, %322
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %8) #39
...
218:                                              ; preds = %206, %194, %202, %187, %175, %183, %86, %74, %82, %53, %41, %49
...
221:                                              ; preds = %218, %202, %183, %82, %49, %187, %206, %53, %86
...
119:                                              ; preds = %116
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %8) #39
...
129:                                              ; preds = %131, %124, %119
  %130 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %8) #39
  br label %198
...
; Function Attrs: sspstrong uwtable
define hidden void @_ZThn16_NK5osgeo4proj8metadata10Identifier12_exportToWKTEPNS0_2io12WKTFormatterE(ptr noundef readonly captures(none) %0, ptr noundef nonnull %1) unnamed_addr #21 align 2 {
...
83:                                               ; preds = %82
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %10) #39
...
96:                                               ; preds = %90, %93
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %10) #39
...
97:                                               ; preds = %96
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %11) #39
...
179:                                              ; preds = %176
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %12) #39
...
192:                                              ; preds = %186, %189
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %13) #39
...
214:                                              ; preds = %216, %197, %192
  %215 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %13) #39
  br label %312
...
284:                                              ; preds = %279
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %15) #39
...
297:                                              ; preds = %291, %294
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %15) #39
...
312:                                              ; preds = %201, %199, %310, %277, %214, %213, %167, %164, %152, %151
...
; Function Attrs: sspstrong uwtable
define hidden void @_ZThn24_NK5osgeo4proj8metadata10Identifier13_exportToJSONEPNS0_2io13JSONFormatterE(ptr noundef readonly captures(none) %0, ptr noundef %1) unnamed_addr #21 align 2 {
...
57:                                               ; preds = %17, %21, %9, %50, %45, %41, %33, %30
...
372:                                              ; preds = %306, %68, %78, %88, %98, %115, %125, %135, %145, %155, %165, %185, %195, %205, %215, %225, %296, %286, %276, %266, %61, %59, %107, %105, %338, %172, %178, %259, %253, %336
...
462:                                              ; preds = %456, %382, %392, %402, %412, %422, %432, %442, %452, %372
...
479:                                              ; preds = %376, %386, %396, %406, %416, %426, %436, %446, %456, %467, %462
...
502:                                              ; preds = %479, %479, %479, %479, %479, %479, %479, %479, %479, %327, %246, %103, %170, %362, %55, %496, %21
...
define internal fastcc noundef ptr @_ZN5osgeo4proj8metadataL21get_ascii_replacementEPKc(ptr noundef readonly captures(none) %0) unnamed_addr #26 {
...
define noundef zeroext i1 @_ZN5osgeo4proj8metadata10Identifier16isEquivalentNameEPKcS4_b(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1, i1 noundef zeroext %2) local_unnamed_addr #28 align 2 personality ptr @__gxx_personality_v0 {
...
139:                                              ; preds = %133, %59, %69, %79, %89, %99, %109, %119, %129, %56
...
192:                                              ; preds = %186, %152, %162, %172, %182, %148
...
201:                                              ; preds = %150, %156, %166, %176, %186, %197, %192, %144, %139
...
204:                                              ; preds = %63, %73, %83, %93, %103, %113, %123, %133, %202
...
244:                                              ; preds = %238, %204, %214, %224, %234, %201
...
337:                                              ; preds = %331, %257, %267, %277, %287, %297, %307, %317, %327, %253
...
346:                                              ; preds = %57, %202, %255, %261, %271, %281, %291, %301, %311, %321, %331, %244, %249, %337, %342
...
347:                                              ; preds = %238, %228, %218, %208, %346, %346, %346, %346, %346, %346, %346, %346, %346
  %348 = add i64 %16, 1
...
444:                                              ; preds = %407, %417, %427, %402, %399, %395, %397, %437, %442
...
496:                                              ; preds = %459, %469, %479, %453, %489, %444, %450
...
575:                                              ; preds = %508, %518, %528, %538, %548, %558, %505, %501, %497, %499, %568, %573
...
646:                                              ; preds = %589, %599, %609, %619, %629, %583, %639, %575, %580
...
786:                                              ; preds = %729, %739, %749, %759, %769, %660, %670, %680, %690, %700, %710, %647, %726, %657, %648, %654, %784, %779, %723, %717, %715
...
922:                                              ; preds = %865, %875, %885, %895, %905, %798, %808, %818, %828, %838, %848, %786, %862, %795, %788, %792, %853, %855, %859, %915, %920, %394
...
961:                                              ; preds = %956, %496, %646, %494, %644, %51, %36, %392, %371, %350, %347
...
973:                                              ; preds = %197, %342, %952, %961, %3
  %974 = phi i1 [ true, %3 ], [ true, %197 ], [ true, %342 ], [ false, %952 ], [ true, %961 ]
  ret i1 %974
}

; Function Attrs: mustprogress nofree norecurse nounwind sspstrong willreturn memory(read, inaccessiblemem: none) uwtable
define noundef zeroext i1 @_ZN5osgeo4proj8metadata10Identifier16isEquivalentNameEPKcS4_(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #28 align 2 {
...
declare noalias noundef nonnull ptr @_Znwm(i64 noundef) local_unnamed_addr #33
...
; Function Attrs: inlinehint mustprogress sspstrong uwtable
define linkonce_odr hidden void @_ZN5osgeo4proj8metadata6Extent7PrivateC2ERKS3_(ptr noundef nonnull align 8 dereferenceable(112) %0, ptr noundef nonnull align 8 dereferenceable(112) %1) unnamed_addr #22 comdat align 2 personality ptr @__gxx_personality_v0 {
  %3 = alloca i64, align 8
...
; Function Attrs: inlinehint mustprogress sspstrong uwtable
define linkonce_odr hidden void @_ZN5osgeo4proj8metadata10Identifier7PrivateC2ERKS3_(ptr noundef nonnull align 8 dereferenceable(224) %0, ptr noundef nonnull align 8 dereferenceable(224) %1) unnamed_addr #22 comdat align 2 personality ptr @__gxx_personality_v0 {
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %5 = alloca i64, align 8
  %6 = alloca i64, align 8
...
attributes #15 = { mustprogress nofree nosync nounwind sspstrong willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #16 = { inlinehint mustprogress nounwind sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #17 = { mustprogress nofree nounwind willreturn memory(read) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #18 = { mustprogress nofree nounwind sspstrong willreturn memory(read, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #19 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(read, inaccessiblemem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #20 = { mustprogress nocallback nofree nounwind willreturn memory(argmem: write) }
attributes #21 = { sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #22 = { inlinehint mustprogress sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #23 = { nofree nosync nounwind memory(none) }
attributes #24 = { noinline noreturn nounwind sspstrong uwtable "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #25 = { cold nofree noreturn }
attributes #26 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #28 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(read, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #31 = { cold noreturn "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #33 = { nobuiltin allocsize(0) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
