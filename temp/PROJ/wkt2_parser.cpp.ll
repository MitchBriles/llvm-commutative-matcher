; ModuleID = '/home/mitch/Documents/PROJ/src/wkt2_parser.cpp'
...
53:                                               ; preds = %47
  ...
  %55 = add i64 %54, 1
  call void @_ZdlPvm(ptr noundef %48, i64 noundef %55) #11
  br label %56
...
define hidden i32 @pj_wkt2_lex(ptr noundef readnone captures(none) %0, ptr noundef captures(none) %1) local_unnamed_addr #3 {
...
15:                                               ; preds = %10
  ...
  %17 = tail call i32 @isalpha(i32 noundef %16) #12
  %18 = icmp eq i32 %17, 0
...
19:                                               ; preds = %15, %35
  ...
  %23 = tail call noundef zeroext i1 @_ZN5osgeo4proj8internal14ci_starts_withEPKcS3_(ptr noundef nonnull %6, ptr noundef %22) #10
  br i1 %23, label %24, label %35

24:                                               ; preds = %19
  %25 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %22) #12
  %26 = getelementptr inbounds nuw i8, ptr %6, i64 %25
  %27 = load i8, ptr %26, align 1, !tbaa !13
  %28 = sext i8 %27 to i32
  %29 = tail call i32 @isalpha(i32 noundef %28) #12
  %30 = icmp eq i32 %29, 0
...
84:                                               ; preds = %80
  %85 = tail call noundef ptr @strstr(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(1) @.str.1) #12
  store ptr %85, ptr %3, align 8, !tbaa !18
  %86 = icmp eq ptr %85, null
  br i1 %86, label %87, label %90

87:                                               ; preds = %84
  %88 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %6) #12
...
96:                                               ; preds = %87, %90, %92, %75, %74, %62, %53, %31, %14
