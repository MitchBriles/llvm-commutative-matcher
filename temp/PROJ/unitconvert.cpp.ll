; ModuleID = '/home/mitch/Documents/PROJ/src/conversions/unitconvert.cpp'
...
36:                                               ; preds = %26, %31
  ...
  %39 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %38, ptr noundef nonnull readonly dereferenceable(1) %27) #12
  %40 = icmp eq i32 %39, 0
...
52:                                               ; preds = %43, %47
  ...
  %55 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %54, ptr noundef nonnull readonly dereferenceable(1) %27) #12
  %56 = icmp eq i32 %55, 0
...
84:                                               ; preds = %79
  %85 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %80, ptr noundef nonnull dereferenceable(7) @.str.5) #12
  %86 = icmp eq i32 %85, 0
...
88:                                               ; preds = %87, %84
  %89 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %80, ptr noundef nonnull dereferenceable(7) @.str.6) #12
  %90 = icmp eq i32 %89, 0
...
110:                                              ; preds = %100, %105
  ...
  %113 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %112, ptr noundef nonnull readonly dereferenceable(1) %101) #12
...
126:                                              ; preds = %117, %121
  ...
  %129 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %128, ptr noundef nonnull readonly dereferenceable(1) %101) #12
...
160:                                              ; preds = %153
  %161 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %154, ptr noundef nonnull dereferenceable(7) @.str.5) #12
...
164:                                              ; preds = %163, %160
  %165 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %154, ptr noundef nonnull dereferenceable(7) @.str.6) #12
...
192:                                              ; preds = %182, %187
  ...
  %195 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %194, ptr noundef nonnull readonly dereferenceable(1) %183) #12
...
208:                                              ; preds = %199, %203
  ...
  %211 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %210, ptr noundef nonnull readonly dereferenceable(1) %183) #12
...
255:                                              ; preds = %245, %250
  ...
  %258 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %257, ptr noundef nonnull readonly dereferenceable(1) %246) #12
...
271:                                              ; preds = %262, %266
  ...
  %274 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %273, ptr noundef nonnull readonly dereferenceable(1) %246) #12
...
316:                                              ; preds = %310
  %317 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %314, ptr noundef nonnull dereferenceable(4) @.str.27) #12
  %318 = icmp eq i32 %317, 0
  br i1 %318, label %330, label %319

319:                                              ; preds = %316
  %320 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %314, ptr noundef nonnull dereferenceable(12) @.str.29) #12
  %321 = icmp eq i32 %320, 0
  br i1 %321, label %330, label %322

322:                                              ; preds = %319
  %323 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %314, ptr noundef nonnull dereferenceable(9) @.str.31) #12
  %324 = icmp eq i32 %323, 0
  br i1 %324, label %330, label %325

325:                                              ; preds = %322
  %326 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %314, ptr noundef nonnull dereferenceable(9) @.str.33) #12
...
341:                                              ; preds = %335
  %342 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %339, ptr noundef nonnull dereferenceable(4) @.str.27) #12
  %343 = icmp eq i32 %342, 0
  br i1 %343, label %355, label %344

344:                                              ; preds = %341
  %345 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %339, ptr noundef nonnull dereferenceable(12) @.str.29) #12
  %346 = icmp eq i32 %345, 0
  br i1 %346, label %355, label %347

347:                                              ; preds = %344
  %348 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %339, ptr noundef nonnull dereferenceable(9) @.str.31) #12
  %349 = icmp eq i32 %348, 0
  br i1 %349, label %355, label %350

350:                                              ; preds = %347
  %351 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %339, ptr noundef nonnull dereferenceable(9) @.str.33) #12
...
360:                                              ; preds = %297, %237, %168, %92, %335, %355, %353, %328, %308, %175, %4
...
4:                                                ; preds = %1
  ...
  %6 = tail call i64 @lround(double noundef %5) #13, !tbaa !76
  %7 = freeze i64 %6
...
define internal noundef double @_ZL15mjd_to_yyyymmddd(double noundef %0) #7 {
  %2 = tail call i64 @lround(double noundef %0) #13, !tbaa !76
