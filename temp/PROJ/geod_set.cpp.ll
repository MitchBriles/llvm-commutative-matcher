; ModuleID = '/home/mitch/Documents/PROJ/src/apps/geod_set.cpp'
...
53:                                               ; preds = %46
  %54 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %51, ptr noundef nonnull dereferenceable(1) %37) #8
  %55 = icmp eq i32 %54, 0
...
69:                                               ; preds = %45, %67, %68
  ...
  %72 = call double @sqrt(double noundef %71) #7, !tbaa !21
...
118:                                              ; preds = %102, %98, %113, %117, %107, %69
