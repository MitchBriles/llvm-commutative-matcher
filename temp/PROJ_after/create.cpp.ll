; ModuleID = 'temp/PROJ/create.cpp.ll'
...
289:                                              ; preds = %300, %283, %281, %279, %273, %265, %257
...
364:                                              ; preds = %356, %352, %344, %340
  %365 = phi i32 [ 1, %344 ], [ 1, %356 ], [ 0, %352 ], [ 0, %340 ]
  call void @llvm.lifetime.end.p0(ptr %9)
  br label %366

366:                                              ; preds = %364, %322, %316, %254, %180, %133, %100, %53, %33, %27, %11, %1
