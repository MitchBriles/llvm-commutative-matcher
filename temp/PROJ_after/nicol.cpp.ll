; ModuleID = 'temp/PROJ/nicol.cpp.ll'
...
13:                                               ; preds = %9
  ...
  %15 = fmul double %0, %14
  %16 = tail call double @sin(double noundef %1) #6, !tbaa !43
...
22:                                               ; preds = %18
  ...
  %29 = tail call double @sin(double noundef %1) #6, !tbaa !43
  ...
  %44 = tail call double @cos(double noundef %1) #6, !tbaa !43
  ...
  %61 = tail call double @sqrt(double noundef %60) #6, !tbaa !43
