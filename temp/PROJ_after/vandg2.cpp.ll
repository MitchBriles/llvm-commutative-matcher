; ModuleID = 'temp/PROJ/vandg2.cpp.ll'
source_filename = "/home/mitch/Documents/PROJ/src/projections/vandg2.cpp"
...
3:                                                ; preds = %1
  %4 = tail call noalias dereferenceable_or_null(4) ptr @calloc(i64 noundef 1, i64 noundef 4) #6
...
8:                                                ; preds = %3
  ...
  store ptr @_ZL16vandg2_s_forward5PJ_LPP8PJconsts, ptr %10, align 8, !tbaa !37
  br label %20
...
14:                                               ; preds = %11
  ...
  store ptr @_ZL10des_vandg2, ptr %16, align 8, !tbaa !39
...
20:                                               ; preds = %14, %11, %8, %6
  %21 = phi ptr [ %12, %14 ], [ null, %11 ], [ %7, %6 ], [ %0, %8 ]
  ret ptr %21
}

; Function Attrs: mustprogress sspstrong uwtable
define hidden noundef ptr @_Z35pj_projection_specific_setup_vandg2P8PJconsts(ptr noundef %0) local_unnamed_addr #0 {
  %2 = tail call noalias dereferenceable_or_null(4) ptr @calloc(i64 noundef 1, i64 noundef 4) #6
...
6:                                                ; preds = %1
  ...
  store ptr @_ZL16vandg2_s_forward5PJ_LPP8PJconsts, ptr %8, align 8, !tbaa !37
  br label %9
...
11:                                               ; preds = %3
  %12 = tail call double @sqrt(double noundef %9) #7, !tbaa !43
  br label %13

13:                                               ; preds = %11, %3
  %14 = phi double [ %12, %11 ], [ 0.000000e+00, %3 ]
...
17:                                               ; preds = %13
  ...
  %19 = select i1 %18, double %8, double %7
  %20 = fmul double %19, 0x400921FB54442D18
  %21 = fadd double %14, 1.000000e+00
  %22 = fdiv double %20, %21
  br label %66

23:                                               ; preds = %13
  %24 = fdiv double 0x400921FB54442D18, %0
  %25 = fdiv double %0, 0x400921FB54442D18
...
31:                                               ; preds = %23
  ...
  %33 = fdiv double %7, %32
  %34 = tail call double @llvm.fmuladd.f64(double %28, double %28, double 1.000000e+00)
  %35 = fneg double %33
  %36 = tail call double @llvm.fmuladd.f64(double %35, double %33, double %34)
  %37 = tail call double @sqrt(double noundef %36) #7, !tbaa !43
  %38 = fsub double %37, %28
  br label %55

39:                                               ; preds = %23
  %40 = tail call double @llvm.fmuladd.f64(double %28, double %28, double 1.000000e+00)
  %41 = tail call double @llvm.sqrt.f64(double %40)
  %42 = fmul double %28, %14
  %43 = fneg double %14
  %44 = fmul double %42, %43
  %45 = tail call double @llvm.fmuladd.f64(double %14, double %41, double %44)
  %46 = fmul double %28, %28
  %47 = fmul double %7, %46
  %48 = tail call double @llvm.fmuladd.f64(double %47, double %7, double 1.000000e+00)
  %49 = fdiv double %45, %48
  %50 = tail call double @llvm.fmuladd.f64(double %28, double 2.000000e+00, double %49)
  %51 = fneg double %49
  %52 = tail call double @llvm.fmuladd.f64(double %51, double %50, double 1.000000e+00)
  %53 = fadd double %52, 1.000000e-10
  %54 = tail call double @sqrt(double noundef %53) #7, !tbaa !43
  br label %55

55:                                               ; preds = %39, %31
  %56 = phi double [ %33, %31 ], [ %54, %39 ]
  %57 = phi double [ %38, %31 ], [ %49, %39 ]
  %58 = fmul double %57, 0x400921FB54442D18
  %59 = fmul double %56, 0x400921FB54442D18
...
66:                                               ; preds = %64, %55, %17
  %67 = phi double [ %22, %17 ], [ %65, %64 ], [ %59, %55 ]
  %68 = phi double [ 0.000000e+00, %17 ], [ %62, %64 ], [ %62, %55 ]
  %69 = insertvalue { double, double } poison, double %68, 0
  %70 = insertvalue { double, double } %69, double %67, 1
...
8:                                                ; preds = %3
  ...
  store ptr @_ZL16vandg2_s_forward5PJ_LPP8PJconsts, ptr %11, align 8, !tbaa !37
  br label %21
...
15:                                               ; preds = %12
  ...
  store ptr @.str.1, ptr %16, align 8, !tbaa !38
  %17 = getelementptr inbounds nuw i8, ptr %13, i64 16
  store ptr @_ZL10des_vandg3, ptr %17, align 8, !tbaa !39
...
6:                                                ; preds = %1
  ...
  store ptr @_ZL16vandg2_s_forward5PJ_LPP8PJconsts, ptr %9, align 8, !tbaa !37
  br label %10
