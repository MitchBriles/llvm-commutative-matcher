; ModuleID = 'temp/PROJ/internal.cpp.ll'
...
32:                                               ; preds = %22
  ...
  %34 = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcmm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef %33, i64 noundef 0, i64 noundef %26) #22
  %35 = icmp eq i64 %34, -1
...
44:                                               ; preds = %36
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.5, i64 noundef %37, i64 noundef %41) #9
...
50:                                               ; preds = %46
  ...
  %55 = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcmm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef %52, i64 noundef %51, i64 noundef %53) #22
  %56 = icmp eq i64 %55, -1
...
10:                                               ; preds = %2
  ...
  %13 = tail call i32 @strncasecmp(ptr noundef readonly %11, ptr noundef readonly %12, i64 noundef %4) #24
  %14 = icmp eq i32 %13, 0
  br label %15
...
8:                                                ; preds = %2
  ...
  %10 = tail call i32 @strncasecmp(ptr noundef readonly %9, ptr noundef nonnull readonly %1, i64 noundef %4) #24
  %11 = icmp eq i32 %10, 0
  br label %12
...
define hidden noundef zeroext i1 @_ZN5osgeo4proj8internal8ci_equalEPKcS3_(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #3 personality ptr @__gxx_personality_v0 {
...
6:                                                ; preds = %2
  %7 = tail call i32 @strncasecmp(ptr noundef nonnull readonly %0, ptr noundef nonnull readonly %1, i64 noundef %3) #24
  %8 = icmp eq i32 %7, 0
  br label %9
...
define noundef i64 @_ZN5osgeo4proj8internal7ci_findERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPKc(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #5 personality ptr @__gxx_personality_v0 {
...
12:                                               ; preds = %17, %8
  ...
  %15 = tail call i32 @strncasecmp(ptr noundef readonly %14, ptr noundef nonnull readonly %1, i64 noundef %3) #24
  %16 = icmp eq i32 %15, 0
...
16:                                               ; preds = %21, %12
  ...
  %19 = tail call i32 @strncasecmp(ptr noundef readonly %18, ptr noundef readonly %14, i64 noundef %5) #24
  %20 = icmp eq i32 %19, 0
...
; Function Attrs: mustprogress nofree norecurse nounwind sspstrong willreturn memory(read) uwtable
define noundef zeroext i1 @_ZN5osgeo4proj8internal14ci_starts_withEPKcS3_(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #3 personality ptr @__gxx_personality_v0 {
  %3 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #24
  %4 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %1) #24
  %5 = icmp ult i64 %3, %4
...
6:                                                ; preds = %2
  %7 = tail call i32 @strncasecmp(ptr noundef nonnull readonly %0, ptr noundef nonnull readonly %1, i64 noundef %4) #24
  %8 = icmp eq i32 %7, 0
  br label %9
...
10:                                               ; preds = %2
  %11 = load ptr, ptr %0, align 8, !tbaa !10
  %12 = load ptr, ptr %1, align 8, !tbaa !10
  %13 = tail call i32 @strncasecmp(ptr noundef readonly %11, ptr noundef readonly %12, i64 noundef %7) #24
  %14 = icmp eq i32 %13, 0
  br label %15
...
8:                                                ; preds = %6
  tail call void @__cxa_throw(ptr nonnull %7, ptr nonnull @_ZTISt16invalid_argument, ptr nonnull @_ZNSt16invalid_argumentD1Ev) #25
  unreachable
...
95:                                               ; preds = %79
  ...
  %97 = add i64 %96, 1
  call void @_ZdlPvm(ptr noundef %88, i64 noundef %97) #23
  br label %98
...
98:                                               ; preds = %95, %91
  ...
  call void @_ZNSt6localeD1Ev(ptr noundef nonnull align 8 dereferenceable(8) %99) #22
  ...
  call void @_ZNSt8ios_baseD2Ev(ptr noundef nonnull align 8 dereferenceable(264) %106) #22
  call void @llvm.lifetime.end.p0(ptr %3)
  br label %109
...
26:                                               ; preds = %20
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7, i64 noundef %22, i64 noundef %23) #9
...
78:                                               ; preds = %75, %72
  ...
  %79 = add nuw i64 %21, 1
  %80 = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEcm(ptr noundef nonnull align 8 dereferenceable(32) %1, i8 noundef signext %2, i64 noundef %79) #22
  %81 = icmp eq i64 %80, -1
...
103:                                              ; preds = %98
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7, i64 noundef %79, i64 noundef %100) #9
...
define void @_ZN5osgeo4proj8internal5splitERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES9_(ptr dead_on_unwind noalias writable sret(%"class.std::vector") align 8 initializes((0, 24)) %0, ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %2) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
  ...
  %12 = tail call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcmm(ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef %9, i64 noundef 0, i64 noundef %10) #22
  %13 = icmp eq i64 %12, -1
...
30:                                               ; preds = %24
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7, i64 noundef %26, i64 noundef %27) #9
...
82:                                               ; preds = %79, %76
  ...
  %87 = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcmm(ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef %86, i64 noundef %85, i64 noundef %83) #22
  %88 = icmp eq i64 %87, -1
...
110:                                              ; preds = %105
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7, i64 noundef %85, i64 noundef %107) #9
...
8:                                                ; preds = %3
  %9 = call noundef ptr @strstr(ptr noundef nonnull dereferenceable(1) %5, ptr noundef nonnull dereferenceable(1) @.str.3) #24
...
13:                                               ; preds = %11, %8, %3
  ...
  %15 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %5) #22
  call void @llvm.lifetime.start.p0(ptr %4)
...
7:                                                ; preds = %3
  tail call void @_ZSt19__throw_logic_errorPKc(ptr noundef nonnull @.str.9) #9
  unreachable
...
32:                                               ; preds = %19
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.11) #9
...
35:                                               ; preds = %33
  %36 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %3) #22
...
12:                                               ; preds = %2
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.10) #9
  unreachable
...
attributes #1 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(read, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #2 = { mustprogress nocallback nofree nounwind willreturn memory(argmem: read) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #3 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #5 = { mustprogress nofree norecurse nounwind sspstrong memory(read, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #6 = { mustprogress nofree norecurse nounwind sspstrong willreturn memory(read, inaccessiblemem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
