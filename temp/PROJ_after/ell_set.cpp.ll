; ModuleID = 'temp/PROJ/ell_set.cpp.ll'
...
37:                                               ; preds = %45, %23
  ...
  %40 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %39, ptr noundef nonnull dereferenceable(6) @.str.5, i64 noundef 5) #15
  %41 = icmp eq i32 %40, 0
...
48:                                               ; preds = %42, %42
  %49 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %39) #15
...
63:                                               ; preds = %58, %53
  ...
  %66 = tail call i32 @strcmp(ptr noundef nonnull readonly dereferenceable(1) %54, ptr noundef nonnull dereferenceable(1) %65) #15
  %67 = icmp eq i32 %66, 0
...
173:                                              ; preds = %169, %167, %162, %84, %77, %75, %51
...
214:                                              ; preds = %212, %190, %182, %179, %176, %173, %35, %29, %26
...
40:                                               ; preds = %26, %26, %15, %15
  ...
  %45 = tail call noundef ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %42, i32 noundef 61) #15
...
9:                                                ; preds = %3
  %10 = tail call double @sqrt(double noundef %2) #14, !tbaa !73
  store double %10, ptr %6, align 8, !tbaa !55
  br label %11

11:                                               ; preds = %9, %3
  %12 = phi double [ %10, %9 ], [ %7, %3 ]
  %13 = tail call double @asin(double noundef %12) #14, !tbaa !73
  %14 = getelementptr inbounds nuw i8, ptr %0, i64 200
  store double %13, ptr %14, align 8, !tbaa !54
  %15 = tail call double @tan(double noundef %13) #14, !tbaa !73
...
20:                                               ; preds = %11
  %21 = tail call double @sin(double noundef %13) #14, !tbaa !73
  %22 = fneg double %21
  %23 = tail call double @llvm.fmuladd.f64(double %22, double %21, double 2.000000e+00)
  %24 = tail call double @sqrt(double noundef %23) #14, !tbaa !73
...
34:                                               ; preds = %26
  %35 = tail call double @cos(double noundef %13) #14, !tbaa !73
...
44:                                               ; preds = %37
  ...
  %49 = tail call double @cos(double noundef %13) #14, !tbaa !73
  ...
  %60 = tail call double @tan(double noundef %59) #14, !tbaa !73
...
7:                                                ; preds = %15, %1
  ...
  %10 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %9, ptr noundef nonnull readonly dereferenceable(3) @.str.11, i64 noundef 2) #15
  %11 = icmp eq i32 %10, 0
...
29:                                               ; preds = %37, %26
  ...
  %32 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %31, ptr noundef nonnull readonly dereferenceable(3) @.str.13, i64 noundef 2) #15
  %33 = icmp eq i32 %32, 0
  br i1 %33, label %34, label %37
...
71:                                               ; preds = %12, %12
  ...
  %79 = tail call noundef ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %72, i32 noundef 61) #15
...
93:                                               ; preds = %23, %23
  ...
  %101 = tail call noundef ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %94, i32 noundef 61) #15
...
117:                                              ; preds = %34, %34
  ...
  %126 = tail call noundef ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %118, i32 noundef 61) #15
...
136:                                              ; preds = %45, %45
  ...
  %144 = tail call noundef ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %137, i32 noundef 61) #15
...
157:                                              ; preds = %56, %56
  ...
  %166 = tail call noundef ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %158, i32 noundef 61) #15
...
186:                                              ; preds = %180, %178, %154, %117, %109, %87
...
191:                                              ; preds = %189, %186, %172, %152, %134, %107, %85, %66, %62
...
6:                                                ; preds = %14, %1
  ...
  %9 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %8, ptr noundef nonnull readonly dereferenceable(4) @.str.21, i64 noundef 3) #15
  %10 = icmp eq i32 %9, 0
...
17:                                               ; preds = %25, %14
  ...
  %20 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %19, ptr noundef nonnull readonly dereferenceable(4) @.str.22, i64 noundef 3) #15
  %21 = icmp eq i32 %20, 0
...
28:                                               ; preds = %36, %25
  ...
  %31 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %30, ptr noundef nonnull readonly dereferenceable(4) @.str.23, i64 noundef 3) #15
  %32 = icmp eq i32 %31, 0
...
39:                                               ; preds = %47, %36
  ...
  %42 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %41, ptr noundef nonnull readonly dereferenceable(4) @.str.24, i64 noundef 3) #15
  %43 = icmp eq i32 %42, 0
...
50:                                               ; preds = %58, %47
  ...
  %53 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %52, ptr noundef nonnull readonly dereferenceable(4) @.str.25, i64 noundef 3) #15
  %54 = icmp eq i32 %53, 0
...
61:                                               ; preds = %69, %58
  ...
  %64 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %63, ptr noundef nonnull readonly dereferenceable(8) @.str.26, i64 noundef 7) #15
  %65 = icmp eq i32 %64, 0
...
72:                                               ; preds = %80, %69
  ...
  %75 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %74, ptr noundef nonnull readonly dereferenceable(8) @.str.27, i64 noundef 7) #15
  %76 = icmp eq i32 %75, 0
...
83:                                               ; preds = %91, %80
  ...
  %86 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %85, ptr noundef nonnull readonly dereferenceable(4) @.str.28, i64 noundef 3) #15
  %87 = icmp eq i32 %86, 0
...
133:                                              ; preds = %44, %44
  ...
  %143 = tail call double @sqrt(double noundef %142) #14, !tbaa !73
...
161:                                              ; preds = %77, %77, %66, %66
  ...
  %168 = tail call noundef ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %164, i32 noundef 61) #15
...
177:                                              ; preds = %161
  %178 = call double @sin(double noundef %172) #14, !tbaa !73
...
189:                                              ; preds = %187
  ...
  %192 = call double @sqrt(double noundef %183) #14, !tbaa !73
...
198:                                              ; preds = %187
  %199 = call double @sqrt(double noundef %188) #14, !tbaa !73
...
204:                                              ; preds = %88, %88
  ...
  %211 = tail call double @sin(double noundef %210) #14, !tbaa !73
...
220:                                              ; preds = %204
  ...
  %222 = tail call double @sqrt(double noundef %221) #14, !tbaa !73
...
227:                                              ; preds = %220, %198, %189, %157, %133, %122, %108, %94
...
238:                                              ; preds = %232, %230, %218, %185, %175, %155, %91, %1
...
7:                                                ; preds = %7, %1
  %8 = phi ptr [ %9, %7 ], [ %3, %1 ]
  tail call void @_ZN16PJCoordOperationD1Ev(ptr noundef nonnull align 8 dereferenceable(188) %8) #14
...
16:                                               ; preds = %13
  ...
  %21 = sub i64 %19, %20
  tail call void @_ZdlPvm(ptr noundef nonnull %14, i64 noundef %21) #16
  br label %22
...
28:                                               ; preds = %28, %22
  ...
  tail call void @_ZN5osgeo4proj9operation15GridDescriptionD1Ev(ptr noundef nonnull align 8 dereferenceable(131) %29) #14
...
37:                                               ; preds = %34
  ...
  %42 = sub i64 %40, %41
  tail call void @_ZdlPvm(ptr noundef nonnull %35, i64 noundef %42) #16
  br label %43
...
52:                                               ; preds = %43
  ...
  %54 = add i64 %53, 1
  tail call void @_ZdlPvm(ptr noundef %45, i64 noundef %54) #16
  br label %55
...
64:                                               ; preds = %55
  ...
  %66 = add i64 %65, 1
  tail call void @_ZdlPvm(ptr noundef %57, i64 noundef %66) #16
  br label %67
...
76:                                               ; preds = %67
  ...
  %78 = add i64 %77, 1
  tail call void @_ZdlPvm(ptr noundef %69, i64 noundef %78) #16
  br label %79
...
88:                                               ; preds = %83
  ...
  tail call void %92(ptr noundef nonnull align 8 dereferenceable(16) %81) #14
  %93 = load ptr, ptr %81, align 8, !tbaa !91
  %94 = getelementptr inbounds nuw i8, ptr %93, i64 24
  %95 = load ptr, ptr %94, align 8
  tail call void %95(ptr noundef nonnull align 8 dereferenceable(16) %81) #14
  br label %107
...
106:                                              ; preds = %103
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %81) #14
  br label %107
...
attributes #10 = { mustprogress noinline nounwind sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
