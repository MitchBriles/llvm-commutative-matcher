; ModuleID = 'temp/PROJ/adams.cpp.ll'
...
13:                                               ; preds = %7
  ...
  %21 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %20, ptr noundef nonnull dereferenceable(7) @.str.7) #8
  %22 = icmp eq i32 %21, 0
...
26:                                               ; preds = %13
  %27 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %20, ptr noundef nonnull dereferenceable(8) @.str.6) #8
  %28 = icmp eq i32 %27, 0
...
32:                                               ; preds = %26
  %33 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %20, ptr noundef nonnull dereferenceable(12) @.str.8) #8
  %34 = icmp eq i32 %33, 0
...
37:                                               ; preds = %32
  %38 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %20, ptr noundef nonnull dereferenceable(12) @.str.9) #8
  %39 = icmp eq i32 %38, 0
...
42:                                               ; preds = %37
  %43 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %20, ptr noundef nonnull dereferenceable(11) @.str.10) #8
  %44 = icmp eq i32 %43, 0
...
63:                                               ; preds = %42
  %64 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %20, ptr noundef nonnull dereferenceable(9) @.str.14) #8
  %65 = icmp eq i32 %64, 0
...
86:                                               ; preds = %84, %82, %80, %66, %61, %59, %45, %40, %35, %29, %23, %11, %7, %5
...
28:                                               ; preds = %20
  %29 = tail call double @sin(double noundef %0) #9, !tbaa !53
  %30 = tail call double @sin(double noundef %1) #9, !tbaa !53
  %31 = tail call double @cos(double noundef %1) #9, !tbaa !53
...
63:                                               ; preds = %54
  %64 = tail call double @sin(double noundef %0) #9, !tbaa !53
  %65 = tail call double @cos(double noundef %0) #9, !tbaa !53
  %66 = tail call double @cos(double noundef %1) #9, !tbaa !53
...
79:                                               ; preds = %3
  %80 = tail call double @sin(double noundef %1) #9, !tbaa !53
...
84:                                               ; preds = %79
  %85 = tail call double @cos(double noundef %1) #9, !tbaa !53
  %86 = tail call double @sin(double noundef %0) #9, !tbaa !53
...
99:                                               ; preds = %3
  ...
  %101 = tail call double @tan(double noundef %100) #9, !tbaa !53
  %102 = load ptr, ptr %2, align 8, !tbaa !47
  %103 = tail call noundef double @_Z5aasinP6pj_ctxd(ptr noundef %102, double noundef %101)
  %104 = tail call double @cos(double noundef %103) #9, !tbaa !53
  %105 = fmul double %0, 5.000000e-01
  %106 = tail call double @sin(double noundef %105) #9, !tbaa !53
...
118:                                              ; preds = %3
  ...
  %120 = tail call double @tan(double noundef %119) #9, !tbaa !53
  %121 = load ptr, ptr %2, align 8, !tbaa !47
  %122 = tail call noundef double @_Z5aasinP6pj_ctxd(ptr noundef %121, double noundef %120)
  %123 = tail call double @cos(double noundef %122) #9, !tbaa !53
  %124 = fmul double %0, 5.000000e-01
  %125 = tail call double @sin(double noundef %124) #9, !tbaa !53
...
134:                                              ; preds = %118, %99, %84, %63, %28, %3
  ...
  %152 = tail call double @cos(double noundef %151) #9, !tbaa !53
...
297:                                              ; preds = %292, %290, %288, %286, %275, %273, %271, %269, %258, %249, %134, %94, %58, %49, %25, %15
...
12:                                               ; preds = %3
  ...
  %14 = tail call double @cos(double noundef %9) #9, !tbaa !53
...
42:                                               ; preds = %39, %36, %33, %30, %21, %19, %11, %10, %7
