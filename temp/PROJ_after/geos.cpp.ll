; ModuleID = 'temp/PROJ/geos.cpp.ll'
...
53:                                               ; preds = %45
  ...
  %56 = tail call double @sqrt(double noundef %55) #7, !tbaa !54
...
11:                                               ; preds = %3
  %12 = fdiv double %1, %10
  %13 = tail call double @tan(double noundef %12) #7, !tbaa !54
  %14 = fdiv double %0, %10
  %15 = tail call double @tan(double noundef %14) #7, !tbaa !54
  %16 = tail call double @hypot(double noundef 1.000000e+00, double noundef %13) #7, !tbaa !54
  %17 = fmul double %15, %16
  br label %25

18:                                               ; preds = %3
  %19 = fdiv double %0, %10
  %20 = tail call double @tan(double noundef %19) #7, !tbaa !54
  %21 = fdiv double %1, %10
  %22 = tail call double @tan(double noundef %21) #7, !tbaa !54
  %23 = tail call double @hypot(double noundef 1.000000e+00, double noundef %20) #7, !tbaa !54
...
46:                                               ; preds = %25
  %47 = fneg double %36
  %48 = tail call double @sqrt(double noundef %42) #7, !tbaa !54
  ...
  %55 = tail call double @atan2(double noundef %53, double noundef %52) #7, !tbaa !54
  %56 = getelementptr inbounds nuw i8, ptr %5, i64 24
  %57 = load double, ptr %56, align 8, !tbaa !58
  %58 = fmul double %57, %54
  %59 = tail call double @hypot(double noundef %52, double noundef %53) #7, !tbaa !54
  %60 = fdiv double %58, %59
  %61 = tail call double @atan(double noundef %60) #7, !tbaa !54
  br label %62
...
define internal { double, double } @_ZL14geos_e_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef %2) #0 {
  ...
  %8 = tail call double @tan(double noundef %1) #7, !tbaa !54
  %9 = fmul double %7, %8
  %10 = tail call double @atan(double noundef %9) #7, !tbaa !54
  %11 = getelementptr inbounds nuw i8, ptr %5, i64 8
  %12 = load double, ptr %11, align 8, !tbaa !55
  %13 = tail call double @cos(double noundef %10) #7, !tbaa !54
  %14 = fmul double %12, %13
  %15 = tail call double @sin(double noundef %10) #7, !tbaa !54
  %16 = tail call double @hypot(double noundef %14, double noundef %15) #7, !tbaa !54
  %17 = fdiv double %12, %16
  %18 = tail call double @cos(double noundef %0) #7, !tbaa !54
  %19 = fmul double %17, %18
  %20 = tail call double @cos(double noundef %10) #7, !tbaa !54
  %21 = fmul double %19, %20
  %22 = tail call double @sin(double noundef %0) #7, !tbaa !54
  %23 = fmul double %17, %22
  %24 = tail call double @cos(double noundef %10) #7, !tbaa !54
  %25 = fmul double %23, %24
  %26 = tail call double @sin(double noundef %10) #7, !tbaa !54
...
48:                                               ; preds = %42
  %49 = tail call double @hypot(double noundef %27, double noundef %30) #7, !tbaa !54
  %50 = fdiv double %25, %49
  %51 = tail call double @atan(double noundef %50) #7, !tbaa !54
  %52 = fmul double %47, %51
  %53 = fdiv double %27, %30
  %54 = tail call double @atan(double noundef %53) #7, !tbaa !54
  %55 = fmul double %47, %54
  br label %64

56:                                               ; preds = %42
  %57 = fdiv double %25, %30
  %58 = tail call double @atan(double noundef %57) #7, !tbaa !54
  %59 = fmul double %47, %58
  %60 = tail call double @hypot(double noundef %25, double noundef %30) #7, !tbaa !54
  %61 = fdiv double %27, %60
  %62 = tail call double @atan(double noundef %61) #7, !tbaa !54
...
19:                                               ; preds = %3
  %20 = fdiv double %0, %10
  %21 = tail call double @tan(double noundef %20) #7, !tbaa !54
  %22 = fdiv double %1, %10
  %23 = tail call double @tan(double noundef %22) #7, !tbaa !54
...
45:                                               ; preds = %27
  %46 = fneg double %35
  %47 = tail call double @sqrt(double noundef %41) #7, !tbaa !54
  ...
  %54 = tail call double @atan2(double noundef %52, double noundef %51) #7, !tbaa !54
  %55 = tail call double @hypot(double noundef %51, double noundef %52) #7, !tbaa !54
  %56 = fdiv double %53, %55
  %57 = tail call double @atan(double noundef %56) #7, !tbaa !54
  br label %58
...
define internal { double, double } @_ZL14geos_s_forward5PJ_LPP8PJconsts(double %0, double %1, ptr noundef readonly captures(none) %2) #5 {
  %4 = getelementptr inbounds nuw i8, ptr %2, i64 88
  %5 = load ptr, ptr %4, align 8, !tbaa !41
  %6 = tail call double @cos(double noundef %1) #7, !tbaa !54
  %7 = tail call double @cos(double noundef %0) #7, !tbaa !54
  %8 = fmul double %6, %7
  %9 = tail call double @sin(double noundef %0) #7, !tbaa !54
  %10 = fmul double %6, %9
  %11 = tail call double @sin(double noundef %1) #7, !tbaa !54
...
20:                                               ; preds = %3
  %21 = tail call double @hypot(double noundef %11, double noundef %14) #7, !tbaa !54
  %22 = fdiv double %10, %21
  %23 = tail call double @atan(double noundef %22) #7, !tbaa !54
  br label %28

24:                                               ; preds = %3
  %25 = fdiv double %10, %14
  %26 = tail call double @atan(double noundef %25) #7, !tbaa !54
  %27 = tail call double @hypot(double noundef %10, double noundef %14) #7, !tbaa !54
  br label %28
...
28:                                               ; preds = %24, %20
  ...
  %33 = tail call double @atan(double noundef %32) #7, !tbaa !54
