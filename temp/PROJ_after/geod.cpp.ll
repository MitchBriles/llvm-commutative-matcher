; ModuleID = 'temp/PROJ/geod.cpp.ll'
...
82:                                               ; preds = %147, %85, %79, %72, %70, %65, %52
...
164:                                              ; preds = %159, %158, %153, %148, %60, %57
...
attributes #5 = { mustprogress norecurse sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
