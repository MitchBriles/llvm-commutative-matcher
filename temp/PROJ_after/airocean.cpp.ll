; ModuleID = 'temp/PROJ/airocean.cpp.ll'
...
19:                                               ; preds = %6
  %20 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %17, ptr noundef nonnull dereferenceable(11) @.str.2) #10
  %21 = icmp eq i32 %20, 0
...
78:                                               ; preds = %19
  %79 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %17, ptr noundef nonnull dereferenceable(9) @.str.3) #10
  %80 = icmp eq i32 %79, 0
...
67:                                               ; preds = %63
  ...
  %105 = tail call double @acos(double noundef %104) #11, !tbaa !66
  %106 = fadd double %105, 0xBFF921FB54442D18
  %107 = tail call double @atan2(double noundef %102, double noundef %101) #11, !tbaa !66
...
111:                                              ; preds = %67
  ...
  %113 = tail call double @tan(double noundef %106) #11, !tbaa !66
  ...
  %126 = tail call double @sqrt(double noundef %125) #11, !tbaa !66
  ...
  %132 = tail call double @sqrt(double noundef %131) #11, !tbaa !66
  %133 = load volatile double, ptr %5, align 8, !tbaa !56
  %134 = fmul double %120, %133
  %135 = fdiv double %132, %134
  %136 = tail call double @atan(double noundef %135) #11, !tbaa !66
  %137 = fneg double %136
...
9:                                                ; preds = %3
  ...
  %18 = tail call double @tan(double noundef %1) #11, !tbaa !66
  %19 = fmul double %18, %17
  %20 = tail call double @atan(double noundef %19) #11, !tbaa !66
  br label %21

21:                                               ; preds = %9, %3
  %22 = phi double [ %20, %9 ], [ %1, %3 ]
  %23 = tail call double @sin(double noundef %22) #11, !tbaa !66
  %24 = tail call double @cos(double noundef %22) #11, !tbaa !66
  %25 = tail call double @sin(double noundef %0) #11, !tbaa !66
  %26 = tail call double @cos(double noundef %0) #11, !tbaa !66
...
define internal fastcc void @_ZN12_GLOBAL__N_116pj_airocean_data8mat_multEPA4_KdS3_PA4_d(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1, ptr noundef nonnull writeonly captures(none) initializes((0, 128)) %2) unnamed_addr #5 align 2 {
