; ModuleID = 'temp/PROJ/trans.cpp.ll'
...
280:                                              ; preds = %279, %274, %248, %221, %188, %168, %142, %115, %104, %80
...
322:                                              ; preds = %318, %316, %311, %307, %303, %290, %288, %278, %274, %269, %257, %252, %248, %245, %168, %163, %151, %146, %142, %139, %103, %57, %50
...
553:                                              ; preds = %552, %549, %534, %525
  call void @llvm.lifetime.end.p0(ptr %9)
  br label %556

554:                                              ; preds = %523, %507, %491, %489, %432, %418
