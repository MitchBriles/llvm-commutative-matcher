; ModuleID = 'temp/PROJ/proj.cpp.ll'
...
25:                                               ; preds = %869, %859, %847, %839, %835, %823, %821, %812, %810, %808, %800, %786, %779, %777, %762, %753, %735
  %26 = landingpad { ptr, i32 }
          cleanup
  br label %1139

27:                                               ; preds = %1080, %1079, %1078, %1065, %1061, %1049, %1047, %1045, %1012, %1010, %1000, %997, %995, %949, %944, %939
  %28 = landingpad { ptr, i32 }
          cleanup
  br label %1139

29:                                               ; preds = %707, %706, %693
...
35:                                               ; preds = %1136, %1129, %654, %632, %622, %618, %597, %592, %590, %585, %578, %576, %574, %562, %368, %359, %356, %225, %67, %2
...
37:                                               ; preds = %22
  ...
  %39 = tail call noundef ptr @strrchr(ptr noundef nonnull dereferenceable(1) %38, i32 noundef 47) #21
...
57:                                               ; preds = %53, %49, %45
  %58 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %46, ptr noundef nonnull dereferenceable(7) @.str.1, i64 noundef 6) #21
  %59 = icmp eq i32 %58, 0
...
70:                                               ; preds = %67
  ...
  %72 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %68, ptr noundef nonnull @.str.45, ptr noundef %69, ptr noundef %71) #22
...
121:                                              ; preds = %152, %118
  ...
  %124 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %122, ptr noundef nonnull dereferenceable(8) @.str.4) #21
  %125 = icmp eq i32 %124, 0
  br i1 %125, label %152, label %126

126:                                              ; preds = %121
  %127 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %122, ptr noundef nonnull dereferenceable(8) @.str.5) #21
  %128 = icmp eq i32 %127, 0
  br i1 %128, label %152, label %129

129:                                              ; preds = %126
  %130 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %122, ptr noundef nonnull dereferenceable(8) @.str.6) #21
...
162:                                              ; preds = %174, %159
  ...
  %165 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %163, ptr noundef nonnull dereferenceable(1) %157) #21
...
227:                                              ; preds = %225, %205, %183, %180, %174, %167, %159, %152, %118
  tail call void @exit(i32 noundef 0) #23
  unreachable
...
258:                                              ; preds = %253, %246
  ...
  %260 = tail call double @strtod(ptr noundef nonnull captures(none) %259, ptr noundef null) #24
...
264:                                              ; preds = %253
  %265 = tail call double @strtod(ptr noundef nonnull captures(none) %243, ptr noundef null) #24
...
280:                                              ; preds = %302, %301, %289, %279, %274, %267, %264, %262, %234, %111, %109, %104, %103, %102, %101, %100, %99, %98, %83
...
295:                                              ; preds = %292
  ...
  %298 = tail call i64 @__isoc23_strtol(ptr noundef nonnull %297, ptr noundef null, i32 noundef 10) #24
  %299 = trunc i64 %298 to i32
  %300 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @_ZL12oform_buffer, i64 noundef 16, ptr noundef nonnull @.str.18, i32 noundef %299) #24
...
346:                                              ; preds = %342, %335, %310, %303, %295, %94, %91
...
415:                                              ; preds = %411
  ...
  %421 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNK5osgeo4proj3crs12ProjectedCRS16coordinateSystemEv(ptr noundef nonnull align 8 dereferenceable(104) %420) #21
  %422 = load ptr, ptr %421, align 8, !tbaa !77
  %423 = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK5osgeo4proj2cs16CoordinateSystem8axisListEv(ptr noundef nonnull align 8 dereferenceable(56) %422) #21
  %424 = load ptr, ptr %423, align 8, !tbaa !80
  %425 = load ptr, ptr %424, align 8, !tbaa !83
  %426 = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNK5osgeo4proj2cs20CoordinateSystemAxis9directionEv(ptr noundef nonnull align 8 dereferenceable(56) %425) #21
  %427 = call noundef zeroext i1 @_ZNK5osgeo4proj4util8CodeListeqERKS2_(ptr noundef nonnull align 8 dereferenceable(32) %426, ptr noundef nonnull align 8 dereferenceable(32) @_ZN5osgeo4proj2cs13AxisDirection5NORTHE) #21
  br i1 %427, label %431, label %428

428:                                              ; preds = %415
  %429 = call noundef zeroext i1 @_ZNK5osgeo4proj4util8CodeListeqERKS2_(ptr noundef nonnull align 8 dereferenceable(32) %426, ptr noundef nonnull align 8 dereferenceable(32) @_ZN5osgeo4proj2cs13AxisDirection5SOUTHE) #21
...
538:                                              ; preds = %518, %462, %460, %458, %407, %405, %403
...
608:                                              ; preds = %604
  %609 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %606, ptr noundef nonnull dereferenceable(31) @.str.33, i64 noundef 30) #21
...
641:                                              ; preds = %632
  ...
  %646 = call double @sqrt(double noundef %645) #24, !tbaa !16
...
715:                                              ; preds = %738, %710
  ...
  %717 = call noundef ptr @strchr(ptr noundef nonnull dereferenceable(1) %716, i32 noundef 10) #21
...
755:                                              ; preds = %747
  %756 = call double @strtod(ptr noundef nonnull %748, ptr noundef nonnull %11) #24
  %757 = load ptr, ptr %11, align 8, !tbaa !5
  %758 = call double @strtod(ptr noundef %757, ptr noundef nonnull %11) #24
...
918:                                              ; preds = %915
  %919 = call noundef ptr @strchr(ptr noundef nonnull dereferenceable(1) %916, i32 noundef 10) #21
...
1139:                                             ; preds = %581, %550, %340, %338, %277, %206, %196, %172, %132, %35, %33, %31, %29, %27, %25
...
attributes #5 = { mustprogress sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #6 = { mustprogress nofree nounwind willreturn memory(read) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #7 = { inlinehint mustprogress nofree nounwind sspstrong willreturn memory(read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
